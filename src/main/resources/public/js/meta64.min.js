...
[],e=0,d=0;;){var g="editNodeTextContent"+e;if(meta64.fieldIdToPropMap.hasOwnProperty(g)){var h=meta64.fieldIdToPropMap[g],g=$("#"+g).val();g!==h.value&&(c.push({name:h.name,value:g}),d++)}else break;e++}0<d?(util.json("saveNode",{nodeId:l.editNode.id,properties:c,sendNotification:b},a),b=!1):alert("You didn't change any information!")},moveNodeUp:function(a){var c=meta64.uidToNodeMap[a];c?(a=meta64.getOrdinalOfNode(c),console.log("ordinal="+a),-1==a&&0>=a||util.json("setNodePosition",{parentNodeId:meta64.currentNodeId,
...
f+"');",id:f+"_row"},d+b.makeTag("div",{id:f+"_content"},b.renderNodeContent(a,!0,!0,!0,!0)))},getTopRightImageTag:function(a){a=props.getNodePropertyVal("img.top.right",a);var c="";a&&(c=b.makeTag("img",{src:a,"class":"top-right-image"},"",!1));return c},makeRowButtonBarHtml:function(a,c,e,d){var f=selButton=createSubNodeButton=editNodeButton=moveNodeUpButton=moveNodeDownButton=insertNodeButton="";b.nodeHasChildren(a)&&(f=b.makeTag("a",{onClick:"nav.openNode('"+a+"');","class":"ui-btn ui-btn-b ui-btn-inline ui-icon-plus ui-mini ui-btn-icon-left"},
...
!1;c&&(meta64.uidToNodeMap={},meta64.idToNodeMap={},meta64.selectedNodes={},meta64.initNode(a.node),meta64.setCurrentNodeData(a));var d="",h=b.renderNodeContent(a.node,!0,!0,!0,!0);if(0<h.length){var f=a.node.uid,h=b.makeTag("div",{"class":"node-table-row inactive-row",onClick:"nav.clickOnNodeRow(this, '"+f+"');",id:f+"_row"},h);$("#mainNodeContent").show();$("#mainNodeContent").html(h)}else $("#mainNodeContent").hide();view.updateStatusBar();b.renderMainPageControls();if(a.children){var g=a.children.length,
k=0;$.each(a.children,function(a,f){var h=b.generateRow(a,f,c,g,k);0!=h.length&&(d+=h,k++)})}0!=d.length||meta64.isAnonUser||(d=b.makeTag("a",{onClick:"edit.createSubNode();","class":"ui-btn ui-btn-inline ui-icon-star ui-btn-icon-left"},"Create Content"));util.setHtmlEnhancedById("#listView",d);meta64.getHighlightedNode()||util.scrollToTop()}else util.setVisibility("#listView",!1),$("#mainNodeContent").html("No default content is available.")},generateRow:function(a,c,d,h,f){if(meta64.isNodeBlackListed(c))return"";
d&&meta64.initNode(c);f++;return b.renderNodeAsListItem(c,a,h,f)},getUrlForNodeAttachment:function(a){return postTargetUrl+"bin?nodeId="+encodeURIComponent(a.path)+"&ver="+a.binVer},adjustImageSize:function(a){var b=$("#"+a.imgId);if(b){var d=b.attr("width"),h=b.attr("height");a.width&&a.height&&(a.width>meta64.deviceWidth-50?(d=meta64.deviceWidth-50,h=d*a.height/a.width,b.attr("width",d),b.attr("height",h)):(b.attr("width",a.width),b.attr("height",a.height)))}},makeImageTag:function(a){var c=b.getUrlForNodeAttachment(a);
a.imgId="imgUid_"+a.uid;if(a.width&&a.height){if(a.width>meta64.deviceWidth-50){var d=meta64.deviceWidth-50;return b.makeTag("img",{src:c,id:a.imgId,width:d+"px",height:d*a.height/a.width+"px"},null,!1)}return b.makeTag("img",{src:c,id:a.imgId,width:a.width+"px",height:a.height+"px"},null,!1)}return b.makeTag("img",{src:c,id:a.imgId},null,!1)},makeTag:function(a,b,d,h){"undefined"===typeof h&&(h=!0);var f="<"+a;b&&(f+=" ",$.each(b,function(a,b){f=b.contains("'")?f+(a+'="'+b+'" '):f+(a+"='"+b+"' ")}));
return f=h?f+(">"+d+"</"+a+">"):f+"/>"},makeEditField:function(a,c){return b.makeTag("label",{"for":c},a)+b.makeTag("input",{type:"text",name:c,id:c},"",!0)},makePasswordField:function(a,c){return b.makeTag("label",{"for":c},a)+b.makeTag("input",{type:"password",name:c,id:c},"",!0)},makeButton:function(a,b,d,h){d="ui-btn ui-btn-inline ui-btn-"+d;h&&(d+=" "+h);return render.makeTag("a",{id:b,"class":d},a)},makeBackButton:function(a,b,d){return render.makeTag("a",{id:b,"class":"ui-btn ui-icon-carat-l ui-btn-inline ui-btn-"+
