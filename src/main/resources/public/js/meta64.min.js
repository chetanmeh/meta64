...
var confirmPg=function(){var c,b,a,d;console.log("Module ready: confirmPg.js");return{domId:"confirmPg",areYouSure:function(e,f,g,h){c=e;b=f;a=g;d=h;meta64.openDialog(confirmPg)},build:function(){var a;a="<h3 id='confirmPgTitle'></h3><p id='confirmPgMessage'></p>"+render.makeBackButton("Yes","confirmPgYesButton","b");a+=render.makeBackButton("No","confirmPgNoButton","a");a=render.makeTag("div",{"data-role":"content"},a);util.setHtmlEnhanced($("#confirmPg"),a);$("#confirmPgYesButton").on("click",function(){d()})},
...
var messagePg=function(){var c,b,a;console.log("Module ready: messagePg.js");return{domId:"messagePg",showMessage:function(d,e,f){c=d;b=e;a=f;meta64.openDialog(messagePg)},build:function(){var b;b="<h3 id='messagePgTitle'></h3><p id='messagePgMessage'></p>"+render.makeBackButton("Ok","messagePgOkButton","b");b=render.makeTag("div",{"data-role":"content"},b);util.setHtmlEnhanced($("#messagePg"),b);$("#messagePgOkButton").on("click",function(){a()})},init:function(){$("#messagePgTitle").text(c);$("#messagePgMessage").html(b)}}}();console.log("running module: popupMenuPg.js");
...
0==b.length)return!0}return!1},changeOrAddClass:function(a,b,c){a=$(a);a.toggleClass(b,!1);a.toggleClass(c,!0)},changeOrAddClass__mine:function(a,b,c){if(a.className&&0!=a.className.length){for(var f=a.className.split(" "),g="",h=!1,l=0;l<f.length;l++){var m=f[l];if(m===c){if(h)continue;h=!0}else if(m===b){if(h)continue;m=c;h=!0}0<g.length&&(g+=" ");g+=m}h||(0<g.length&&(g+=" "),g+=c);a.className=g}else console.log("no existing className is available on element, so assigning to "+c),a.className=c},
