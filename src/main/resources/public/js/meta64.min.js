...
var edit=function(){var d,b,a=function(a){util.checkSuccess("Save node",a);view.refreshTree(null,!1);meta64.jqueryChangePage("#mainPage");view.scrollToSelectedNode()},c=function(a){util.checkSuccess("Rename node",a);view.refreshTree(null,!1);meta64.jqueryChangePage("#mainPage");view.scrollToSelectedNode()},f=function(a){util.checkSuccess("Export",a)&&(alert("Export Successful."),meta64.jqueryChangePage("#mainPage"),view.scrollToSelectedNode())},h=function(a){util.checkSuccess("Import",a)&&(alert("Import Successful."),
view.refreshTree(null,!1),meta64.jqueryChangePage("#mainPage"),view.scrollToSelectedNode())},e=function(a){console.log("insertBookResponse running.");util.checkSuccess("Insert Book",a);view.refreshTree(null,!1);meta64.jqueryChangePage("#mainPage");view.scrollToSelectedNode()},g=function(a){util.checkSuccess("Delete node",a)&&(meta64.clearSelectedNodes(),view.refreshTree(null,!1))},l=function(a){util.checkSuccess("Move nodes",a);k.nodesToMove=null;view.refreshTree(null,!1)},m=function(a){util.checkSuccess("Change node position",
...
(b=!0);meta64.treeDirty=!0;k.nodeInsertTarget?util.json("insertNode",{parentId:d.id,targetName:k.nodeInsertTarget.name,newNodeName:a},n):util.json("createSubNode",{nodeId:d.id,newNodeName:a},q)},saveExistingNode:function(){for(var c=[],f=0,d=0;;){var g="editNodeTextContent"+f;if(meta64.fieldIdToPropMap.hasOwnProperty(g)){var h=meta64.fieldIdToPropMap[g],g=$("#"+g).val();g!==h.value&&(c.push({name:h.name,value:g}),d++)}else break;f++}0<d?(util.json("saveNode",{nodeId:k.editNode.id,properties:c,sendNotification:b},
...
f;var g=f.values&&0<f.values.length,h=render.isReadOnlyProperty(f.name),e=render.isBinaryProperty(f.name);if(h||e)d="RdOnly_"+d;var l="";if(!h&&!e){var l=render.makeTag("a",{onClick:"props.clearProperty('"+d+"');","class":"ui-btn ui-btn-inline ui-icon-back ui-btn-icon-left"},"Clear"),k="",m="";f.name!==jcrCnst.CONTENT&&(m=render.makeTag("a",{onClick:"props.deleteProperty('"+f.name+"');","class":"ui-btn ui-btn-inline ui-icon-delete ui-btn-icon-left"},"Del"),k=render.makeTag("a",{onClick:"props.addSubProperty('"+
d+"');","class":"ui-btn ui-btn-inline ui-icon-star ui-btn-icon-left"},"Add Multi"));l=k+l+m;l=0<l.length?render.makeHorizontalFieldSet(l,"property-edit-button-bar"):""}g?(console.log("Property multi-type: name="+f.name+" count="+f.values.length),l+=props.makeMultiPropEditor(d,f,h,e)):(console.log("Property single-type: "+f.name),l+=render.makeTag("label",{"for":d},render.sanitizePropertyName(f.name)),g=e?"[binary]":f.value,l=h||e?l+render.makeTag("textarea",{id:d,readonly:"readonly",disabled:"disabled"},
g?g:""):l+render.makeTag("textarea",{id:d},g?g:""));a+=render.makeTag("div",{"class":"ui-field-contain property-edit-field"},l);c++}else console.log("Hiding property: "+f.name)});else var b=render.makeTag("label",{"for":"newNodeNameId"},"New Node Name")+render.makeTag("textarea",{id:"newNodeNameId"},""),a=a+render.makeTag("div",{"class":"ui-field-contain property-edit-field"},b);util.setHtmlEnhanced($("#propertyEditFieldContainer"),a);b=k.editingUnsavedNode?"You may leave this field blank and a unique ID will be assigned. You only need to provide a name if you want this node to have a more meaningful URL.":
...
"Delete "+a.length+" node(s) ?","Yes, delete.",function(){util.json("deleteNodes",{nodeIds:a},g)}):alert("You have not selected any nodes. Select nodes to delete first.")},moveSelNodes:function(){var a=meta64.getSelectedNodeIdsArray();a&&0!=a.length?confirmPg.areYouSure("Confirm Move","Move "+a.length+" node(s) to a new location ?","Yes, move.",function(){k.nodesToMove=a;meta64.selectedNodes={};alert("Ok, ready to move nodes. To finish moving, go select the target location, then click 'Finish Moving'");
...
jcrCnst.LAST_MODIFIED,jcrCnst.LAST_MODIFIED_BY,jcrCnst.IMG_WIDTH,jcrCnst.IMG_HEIGHT,jcrCnst.BIN_VER,jcrCnst.BIN_DATA,jcrCnst.BIN_MIME]);util.addAll(b.binaryPropertyList,[jcrCnst.BIN_DATA])},initApp:function(){d||(console.log("initApp running."),d=!0,b.initConstants(),b.displaySignupMessage(),$(window).on("orientationchange",b.orientationHandler),$(window).bind("beforeunload",function(){return"Leave Meta64 ?"}),$(window).on("unload",function(){user.logout(!1)}),b.addClickListeners(),b.deviceWidth=
...
var confirmPg=function(){var d,b,a,c;console.log("Module ready: confirmPg.js");return{domId:"confirmPg",areYouSure:function(f,h,e,g){d=f;b=h;a=e;c=g;meta64.changePage(confirmPg)},build:function(){var a;a="<h3 id='confirmPgTitle'></h3><p id='confirmPgMessage'></p>"+render.makeBackButton("Yes","confirmPgYesButton","b");a+=render.makeBackButton("No","confirmPgNoButton","a");a=render.makeTag("div",{"data-role":"content"},a);util.setHtmlEnhanced($("#confirmPg"),a)},init:function(){$("#confirmPgTitle").text(d);
...
b("Move","moveSelNodesButton","edit.moveSelNodes();")+b("Finish Moving","finishMovingSelNodesButton","edit.finishMovingSelNodes();")+b("Rename","renameNodePgButton","edit.openRenameNodePg();")+b("Delete","deleteSelNodesButton","edit.deleteSelNodes();")+b("Clear Selections","clearSelectionsButton","edit.clearSelections();")+b("Import","openImportPgButton","edit.openImportPg();")+b("Export","openExportPgButton","edit.openExportPg();"),f=d("Edit",f),h=b("Toggle Properties","propsToggleButton","props.propsToggle();")+
b("Refresh","refreshPageButton","view.refreshPage();")+b("Show URL","showFullNodeUrlButton","render.showNodeUrl();"),h=d("View Options",h),a=render.makeTag("div",{style:"margin: 0; min-width: 300px; position: fixed; top: 2em; left: 2em;","data-role":"collapsible-set"},a+f+h);util.setHtmlEnhanced($("#popupMenuPg"),a)},init:function(){var c=util.getPropertyCount(meta64.selectedNodes),b=meta64.getHighlightedNode(),d=!util.nullOrUndef(edit.nodesToMove)&&!a.isAnonUser;util.setEnablement($("#changePasswordPgButton"),
...
c=render.makeBackButton("Cancel","cancelPreferencesPgButton","a"),a=render.makeHorzControlGroup(a+c),c=render.makeBackButton("Close Account","closeAccountButton","a"),c=render.makeHorzControlGroup(c),b=render.makeTag("div",{"class":"ui-field-contain"},b+a+c),b=render.makeTag("div",{role:"main","class":"ui-content dialog-content"},""+b),d=d+b;util.setHtmlEnhanced($("#prefsPg"),d);$("#savePreferencesButton").on("click",prefs.savePreferences);$("#closeAccountButton").on("click",prefs.closeAccount)}}}();console.log("running module: renameNodePg.js");
...
"signupButton","b","ui-btn-icon-left ui-icon-check"),h=render.makeButton("Try Different Image","tryAnotherCaptchaButton","a"),e=render.makeBackButton("Close","cancelSignupButton","a"),f=render.makeHorzControlGroup(f+h+e),a=render.makeTag("div",{"class":"ui-field-contain"},a+c+f),a=render.makeTag("div",{role:"main","class":"ui-content dialog-content",id:d.domId+"-main"},""+a),b=b+a;util.setHtmlEnhanced($("#signupPg"),b);$("#tryAnotherCaptchaButton").on("click",user.tryAnotherCaptcha);$("#signupButton").on("click",
...
edit.editNode.properties.length;c++)if(a===edit.editNode.properties[c].name){edit.editNode.properties.splice(c,1);break}},makeMultiPropEditor:function(a,c,b,d){var e="",g=c.values;g&&0!=g.length||(g=[],g.push(""));for(var l=0;l<g.length;l++){console.log("prop multi-val["+l+"]="+g[l]);var m=a+"_subProp"+l,e=e+render.makeTag("label",{"for":m},(0==l?c.name:"*")+"."+l),n=d?"[binary]":g[l],e=d||b?e+render.makeTag("textarea",{id:m,readonly:"readonly",disabled:"disabled"},n?n:""):e+render.makeTag("textarea",
{id:m},n?n:"")}return e},setPreferredPropertyOrder:function(a){if(a){var c=[];$.each(a,function(a,b){b.name===jcrCnst.CONTENT?c.unshift(b):c.push(b)});return c}},renderProperties:function(a){if(a){var c="<table data-role='table' class='prop-table ui-responsive ui-shadow table-stripe property-text'>",b=0,c=c+"<thead><tr><th></th><th></th></tr></thead>",c=c+"<tbody>";$.each(a,function(a,d){if(render.allowPropertyToDisplay(d.name)){var g=render.isBinaryProperty(d.name);b++;c+="<tr class='prop-table-row'>";
c+="<td class='prop-table-name-col'>"+render.sanitizePropertyName(d.name)+"</td>";c=g?c+"<td class='prop-table-val-col'>[binary]</td>":d.values?c+("<td class='prop-table-val-col'>"+props.renderPropertyValues(d.values)+"</td>"):c+("<td class='prop-table-val-col'>"+render.markdown(d.value)+"</td>");c+="</tr>"}else console.log("Hiding property: "+d.name)});return 0==b?"":c+="</tbody></table>"}},getNodeProperty:function(a,c){if(!c||!c.properties)return null;for(var b=0;b<c.properties.length;b++){var d=
...
var render=function(){var d,b={buildPage:function(a){a.built||(a.build(),a.built=!0);a.init&&a.init()},renderNodeContent:function(a,c,d,h){var e="",g;g=""+b.getTopRightImageTag(a);c&&meta64.editMode&&(e+="<div class='path-display'>Path: "+b.formatPath(a)+"</div>",e+="<div>",a.createdBy&&(e+="<span class='"+(a.createdBy===meta64.userName?"created-by-me":"created-by-other")+"'>Created By: "+a.createdBy+"</span>"),e+="<span id='ownerDisplay"+a.uid+"'></span>",a.lastModified&&(e+="  Modified: "+a.lastModified),
e+="</div>");d&&!c&&a.name&&(e+="Name: "+a.name+" [uid="+a.uid+"]");e&&(g+=b.makeTag("div",{"class":"header-text"},e));if(meta64.showProperties)(c=props.renderProperties(a.properties))&&(g+=c);else if(c=props.getNodeProperty(jcrCnst.CONTENT,a))c=props.renderProperty(c),0<c.length&&(g+=b.makeTag("div",{"class":"jcr-content"},b.markdown(c)));h&&a.hasBinary&&(a.binaryIsImage?a=b.makeImageTag(a):(a=b.makeTag("a",{href:b.getUrlForNodeAttachment(a)},"[Download Attachment]"),a=b.makeTag("div",{"class":"binary-link"},
a)),g=g.contains(cnst.INSERT_ATTACHMENT)?g.replaceAll(cnst.INSERT_ATTACHMENT,a):g+a);return g},renderNodeAsListItem:function(a,c,d,h){var e=a.uid,g=a.id===meta64.newChildNodeId;h=0<c&&1<h;c=c<d-1;d=a.name.startsWith("rep:")||meta64.currentNodeData.node.path.contains("/rep:");d=meta64.isAdminUser||!d;var l=meta64.getHighlightedNode();!g&&l&&l.uid===e&&(g=!0);h=b.makeRowButtonBarHtml(e,h,c,d);c=b.getNodeBkgImageStyle(a);return b.makeTag("div",{"class":"node-table-row"+(g?" active-row":" inactive-row"),
onClick:"nav.clickOnNodeRow(this, '"+e+"');",id:e+"_row",style:c},h+b.makeTag("div",{id:e+"_content"},b.renderNodeContent(a,!0,!0,!0)))},showNodeUrl:function(){var a=meta64.getHighlightedNode();if(a){var c=window.location.origin+"?id="+a.path;meta64.jqueryChangePage("#mainPage");c="URL using path: <br>"+c;(a=props.getNodePropertyVal("jcr:uuid",a))&&(c+="<p>URL for UUID: <br>"+window.location.origin+"?id="+a);messagePg.showMessage("Full External URL of Node",c)}else alert("You must first click on a node.")},
getTopRightImageTag:function(a){a=props.getNodePropertyVal("img.top.right",a);var c="";a&&(c=b.makeTag("img",{src:a,"class":"top-right-image"},"",!1));return c},getNodeBkgImageStyle:function(a){a=props.getNodePropertyVal("img.node.bkg",a);var c="";a&&(c="background-image: url("+a+");");return c},makeRowButtonBarHtml:function(a,c,d,h){var e=selButton=createSubNodeButton=editNodeButton=moveNodeUpButton=moveNodeDownButton=insertNodeButton="";b.nodeHasChildren(a)&&(e=b.makeTag("a",{onClick:"nav.openNode('"+
...
{"for":c},a)+b.makeTag("input",{type:"text",name:c,id:c},"",!0)},makePasswordField:function(a,c){return b.makeTag("label",{"for":c},a)+b.makeTag("input",{type:"password",name:c,id:c},"",!0)},makeButton:function(a,c,b,d){b="ui-btn ui-btn-inline ui-btn-"+b;d&&(b+=" "+d);return render.makeTag("a",{id:c,"class":b},a)},makeBackButton:function(a,b,d){return render.makeTag("a",{id:b,"class":"ui-btn ui-icon-carat-l ui-btn-inline ui-btn-"+d,"data-rel":"back"},a)},allowPropertyToDisplay:function(a){return null==
...
meta64.MODE_ADVANCED:meta64.MODE_SIMPLE},a=function(a,c,f,h){util.checkSuccess("Login",a)?("anonymous"!=c&&(e.writeCookie(cnst.COOKIE_LOGIN_USR,c),e.writeCookie(cnst.COOKIE_LOGIN_PWD,f),e.writeCookie(cnst.COOKIE_LOGIN_STATE,"1")),meta64.jqueryChangePage("#mainPage"),b(a),a.userPreferences.lastNode?console.log("lastNode: "+a.userPreferences.lastNode):console.log("lastNode is null."),c=null,c=util.emptyString(a.homeNodeOverride)?a.userPreferences.lastNode?a.userPreferences.lastNode:meta64.homeNodeId:
a.homeNodeOverride,view.refreshTree(c,!1),d(a)):h&&(alert("Cookie login failed."),$.removeCookie(cnst.COOKIE_LOGIN_USR),$.removeCookie(cnst.COOKIE_LOGIN_PWD),$.writeCookie(cnst.COOKIE_LOGIN_STATE,"0"),location.reload())},c=function(a){meta64.jqueryChangePage("#mainPage");location.reload()},f=function(a){util.checkSuccess("Change password",a)&&alert("Password changed successfully.")},h=function(a){util.checkSuccess("Signup new user",a)&&(user.populateLoginPgFromCookies(),meta64.changePage(loginPg),
alert("User Information Accepted. \n\nCheck your email for signup confirmation. (Can take up to 1 minute)"))},e={twitterLogin:function(){$(window).off("beforeunload");window.location.href=window.location.origin+"/twitterLogin"},openSignupPg:function(){meta64.changePage(signupPg)},writeCookie:function(a,b){$.cookie(a,b,{expires:365,path:"/"})},populateLoginPgFromCookies:function(){var a=$.cookie(cnst.COOKIE_LOGIN_USR),b=$.cookie(cnst.COOKIE_LOGIN_PWD);a&&$("#userName").val(a);b&&$("#password").val(b)},
openLoginPg:function(){meta64.isAnonUser?meta64.changePage(loginPg):e.logout(!0)},signup:function(){var a=util.getRequiredElement("#signupUserName").val(),b=util.getRequiredElement("#signupPassword").val(),c=util.getRequiredElement("#signupEmail").val(),d=util.getRequiredElement("#signupCaptcha").val();util.anyEmpty(a,b,c,d)?alert("Sorry, you cannot leave any fields blank."):util.json("signup",{userName:a,password:b,email:c,captcha:d},h)},pageInitSignupPg:function(){user.tryAnotherCaptcha()},tryAnotherCaptcha:function(){var a=
util.currentTimeMillis(),a=postTargetUrl+"captcha?t="+a;$("#captchaImage").attr("src",a)},refreshLogin:function(){if("0"===$.cookie(cnst.COOKIE_LOGIN_STATE))meta64.loadAnonPageHome(!1);else{var c=$.cookie(cnst.COOKIE_LOGIN_USR),f=$.cookie(cnst.COOKIE_LOGIN_PWD),e=!util.emptyString(c)&&!util.emptyString(f),h=c?c:"{session}",p=f?f:"{session}",c=util.json("login",{userName:h,password:p,usingCookies:e,tzOffset:(new Date).getTimezoneOffset(),dst:util.daylightSavingsTime});e?c.done(function(b){a(b,h,p,
e)}):c.done(function(a){b(a);d(a);meta64.loadAnonPageHome(!1)})}},login:function(){var b=$.trim($("#userName").val()),c=$.trim($("#password").val());util.json("login",{userName:b,password:c,tzOffset:(new Date).getTimezoneOffset(),dst:util.daylightSavingsTime}).done(function(d){a(d,b,c)})},logout:function(a){meta64.isAnonUser||($(window).off("beforeunload"),a&&user.writeCookie(cnst.COOKIE_LOGIN_STATE,"0"),util.json("logout",{},c))},changePassword:function(){var a=util.getRequiredElement("#changePassword1").val(),
b=util.getRequiredElement("#changePassword2").val();a&&4<=a.length&&a===b?util.json("changePassword",{newPassword:a},f):alert("Sorry, invalid password(s).")},changePasswordPg:function(){meta64.changePage(changePasswordPg)}};console.log("Module ready: user.js");return e}();console.log("running module: util.js");
...
this.indexOf(a)});"function"!=typeof String.prototype.replaceAll&&(String.prototype.replaceAll=function(a,b){return this.replace(new RegExp(a.replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1"),"g"),b)});var d=0,b={daylightSavingsTime:(new Date).dst()?!0:!1,json:function(a,b,f){d++;a=$.ajax({url:postTargetUrl+a,contentType:"application/json",type:"post",dataType:"json",cache:!1,data:JSON.stringify(b)});a.done(function(a){"function"==typeof f&&f(a)});a.fail(function(a,b){alert("Server request failed.")});
...
b,d){if(a.className&&0!=a.className.length){for(var h=a.className.split(" "),e="",g=!1,l=0;l<h.length;l++){var m=h[l];if(m===d){if(g)continue;g=!0}else if(m===b){if(g)continue;m=d;g=!0}0<e.length&&(e+=" ");e+=m}g||(0<e.length&&(e+=" "),e+=d);a.className=e}else console.log("no existing className is available on element, so assigning to "+d),a.className=d},verifyType:function(a,b,d){return typeof a!==b?(alert(d),!1):!0},setHtmlEnhancedById:function(a,c){var d=b.getRequiredElement(a);d?($(d).html(c),
