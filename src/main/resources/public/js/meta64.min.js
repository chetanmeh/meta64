...
var edit=function(){var d,b,a=function(a){util.checkSuccess("Save node",a);view.refreshTree(null,!1);meta64.changePage("#mainPage");view.scrollToSelectedNode()},c=function(a){util.checkSuccess("Export",a)&&(alert("Export Successful."),meta64.changePage("#mainPage"),view.scrollToSelectedNode())},e=function(a){util.checkSuccess("Import",a)&&(alert("Import Successful."),view.refreshTree(null,!1),meta64.changePage("#mainPage"),view.scrollToSelectedNode())},g=function(a){console.log("insertBookResponse running.");util.checkSuccess("Insert Book",
a);view.refreshTree(null,!1);meta64.changePage("#mainPage");view.scrollToSelectedNode()},f=function(a){util.checkSuccess("Delete node",a)&&(meta64.clearSelectedNodes(),view.refreshTree(null,!1))},h=function(a){util.checkSuccess("Move nodes",a);l.nodesToMove=null;view.refreshTree(null,!1)},k=function(a){util.checkSuccess("Change node position",a);view.refreshTree(null,!1);meta64.changePage("#mainPage");view.scrollToSelectedNode()},m=function(a){util.checkSuccess("Insert node",a);meta64.newChildNodeId=
a.newNode.id;meta64.initNode(a.newNode);meta64.highlightNode(a.newNode,!0);edit.runEditNode(a.newNode.uid)},n=function(a){util.checkSuccess("Make node referencable",a)&&alert("This node is now referencable, and can be accessed by unique ID")},p=function(a){util.checkSuccess("Create subnode",a);meta64.newChildNodeId=a.newNode.id;console.log("new child identifier: "+meta64.newChildNodeId);meta64.initNode(a.newNode);edit.runEditNode(a.newNode.uid)},l={nodesToMove:null,editingUnsavedNode:!1,editNode:null,
nodeInsertTarget:null,startEditingNewNode:function(){l.editingUnsavedNode=!0;l.editNode=null;meta64.changePage("#editNodePg")},editMode:function(){meta64.editMode=meta64.editMode?!1:!0;var a=$("#editModeButton");a.toggleClass("ui-icon-edit",meta64.editMode);a.toggleClass("ui-icon-forbidden",!meta64.editMode);render.renderPageFromData();view.scrollToSelectedNode()},makeNodeReferencable:function(){util.json("makeNodeReferencable",{nodeId:l.editNode.id},n)},cancelEdit:function(){meta64.treeDirty&&view.refreshTree(null,
!1);meta64.changePage("#mainPage");view.scrollToSelectedNode()},saveNode:function(){l.editingUnsavedNode?l.saveNewNode():l.saveExistingNode()},saveNewNode:function(){var a=util.getRequiredElement("#newNodeNameId").val();meta64.userName!=d.createdBy&&"admin"!=d.createdBy&&(b=!0);meta64.treeDirty=!0;l.nodeInsertTarget?util.json("insertNode",{parentId:d.id,targetName:l.nodeInsertTarget.name,newNodeName:a},m):util.json("createSubNode",{nodeId:d.id,newNodeName:a},p)},saveExistingNode:function(){for(var c=
[],e=0,d=0;;){var h="editNodeTextContent"+e;if(meta64.fieldIdToPropMap.hasOwnProperty(h)){var g=meta64.fieldIdToPropMap[h],h=$("#"+h).val();h!==g.value&&(c.push({name:g.name,value:h}),d++)}else break;e++}0<d?(util.json("saveNode",{nodeId:l.editNode.id,properties:c,sendNotification:b},a),b=!1):alert("You didn't change any information!")},moveNodeUp:function(a){var c=meta64.uidToNodeMap[a];c?(a=meta64.getOrdinalOfNode(c),console.log("ordinal="+a),-1==a&&0>=a||util.json("setNodePosition",{parentNodeId:meta64.currentNodeId,
nodeId:c.name,siblingId:meta64.currentNodeData.children[a-1].name},k)):console.log("idToNodeMap does not contain "+a)},moveNodeDown:function(a){var c=meta64.uidToNodeMap[a];c?(a=meta64.getOrdinalOfNode(c),console.log("ordinal="+a),-1==a&&a>=meta64.currentNodeData.children.length-1||util.json("setNodePosition",{parentNodeId:meta64.currentNodeData.node.id,nodeId:meta64.currentNodeData.children[a+1].name,siblingId:c.name},k)):console.log("idToNodeMap does not contain "+a)},openExportPg:function(){meta64.changePage("#exportPg")},
exportNodes:function(){var a=meta64.getHighlightedNode(),b=util.getRequiredElement("#exportTargetNodeName").val();util.emptyString(b)?alert("Please enter a name for the export file."):a&&util.json("exportToXml",{nodeId:a.id,targetFileName:b},c)},openImportPg:function(){meta64.changePage("#importPg")},importNodes:function(){var a=meta64.getHighlightedNode(),c=util.getRequiredElement("#importTargetNodeName").val();util.emptyString(c)?alert("Please enter a name for the import file."):a&&util.json("import",
{nodeId:a.id,sourceFileName:c},e)},runEditNode:function(a){var c=meta64.uidToNodeMap[a];c?(l.editingUnsavedNode=!1,l.editNode=c,meta64.changePage("#editNodePg")):(l.editNode=null,alert("Unknown nodeId in editNodeClick: "+a))},populateEditNodePg:function(){view.initEditPathDisplayById("#editNodePathDisplay");var a="",c=0;meta64.fieldIdToPropMap={};if(l.editNode)$.each(l.editNode.properties,function(b,e){if(render.allowPropertyToDisplay(e.name)){var d="editNodeTextContent"+c;meta64.fieldIdToPropMap[d]=
e;var h=e.values&&0<e.values.length,g=render.isReadOnlyProperty(e.name),f=render.isBinaryProperty(e.name);if(g||f)d="RdOnly_"+d;var k="";if(!g&&!f){var k=render.makeTag("a",{onClick:"props.clearProperty('"+d+"');","class":"ui-btn ui-btn-inline ui-icon-back ui-btn-icon-left"},"Clear"),l="",m="";e.name!==jcrCnst.CONTENT&&(m=render.makeTag("a",{onClick:"props.deleteProperty('"+e.name+"');","class":"ui-btn ui-btn-inline ui-icon-delete ui-btn-icon-left"},"Del"),l=render.makeTag("a",{onClick:"props.addSubProperty('"+
d+"');","class":"ui-btn ui-btn-inline ui-icon-star ui-btn-icon-left"},"Add Multi"));k=l+k+m;k=0<k.length?render.makeHorizontalFieldSet(k):""}h?(console.log("Property multi-type: name="+e.name+" count="+e.values.length),k+=props.makeMultiPropEditor(d,e,g,f)):(console.log("Property single-type: "+e.name),k+=render.makeTag("label",{"for":d},render.sanitizePropertyName(e.name)),h=f?"[binary]":e.value,k=g||f?k+render.makeTag("textarea",{id:d,readonly:"readonly",disabled:"disabled"},h?h:""):k+render.makeTag("textarea",
{id:d},h?h:""));a+=render.makeTag("div",{"class":"ui-field-contain"},k);c++}else console.log("Hiding property: "+e.name)});else var b=render.makeTag("label",{"for":"newNodeNameId"},"New Node Name")+render.makeTag("textarea",{id:"newNodeNameId"},""),a=a+render.makeTag("div",{"class":"ui-field-contain"},b);util.setHtmlEnhanced($("#propertyEditFieldContainer"),a);b=l.editingUnsavedNode?"You may leave this field blank and a unique ID will be assigned. You only need to provide a name if you want this node to have a more meaningful URL.":
...
createSubNode:function(a){if(a){if(d=meta64.uidToNodeMap[a],!d){console.log("Unknown nodeId in createSubNode: "+a);return}}else d=meta64.currentNode;l.nodeInsertTarget=null;l.startEditingNewNode()},deleteSelNodes:function(){var a=meta64.getSelectedNodeIdsArray();a&&0!=a.length?confirmPg.areYouSure("Confirm Delete","Delete "+a.length+" node(s) ?","Yes, delete.",function(){util.json("deleteNodes",{nodeIds:a},f)}):alert("You have not selected any nodes. Select nodes to delete first.")},moveSelNodes:function(){var a=
...
selectedNodes:{},newChildNodeId:"",currentNodeData:null,currentNode:null,currentNodeUid:null,currentNodeId:null,currentNodePath:null,inSimpleMode:function(){return b.editModeOption===b.MODE_SIMPLE},changePage:function(a){pageMgr.buildPage(a);$.mobile.pageContainer.pagecontainer("change",a)},popup:function(a){pageMgr.buildPage(a);$(a).popup("open")},isNodeBlackListed:function(a){if(!b.inSimpleMode())return!1;for(var c in b.simpleModeNodePrefixBlackList)if(b.simpleModeNodePrefixBlackList.hasOwnProperty(c)&&
a.name.startsWith(c))return!0;return!1},getSelectedNodeUidsArray:function(){var a=[],c=0,e;for(e in b.selectedNodes)b.selectedNodes.hasOwnProperty(e)&&(a[c++]=e);return a},getSelectedNodeIdsArray:function(){var a=[],c=0,e;b.selectedNodes?console.log("selectedNode count: "+b.selectedNodes.length):console.log("no selected nodes.");for(e in b.selectedNodes)if(b.selectedNodes.hasOwnProperty(e)){var d=b.uidToNodeMap[e];d?a[c++]=d.id:console.log("unable to find uidToNodeMap for uid="+e)}return a},getSelectedNodesArray:function(){var a=
[],c=0,e;for(e in b.selectedNodes)b.selectedNodes.hasOwnProperty(e)&&(a[c++]=b.uidToNodeMap[e]);return a},clearSelectedNodes:function(){b.selectedNodes={}},updateNodeInfoResponse:function(a,c){var b="",d=!1;a.owners&&$.each(a.owners,function(a,c){0<b.length&&(b+=",");c===meta64.userName&&(d=!0);b+=c});if(0<b.length){c.owner=b;var f=$("#ownerDisplay"+c.uid);f.html(" (Manager: "+b+")");d?util.changeOrAddClass(f,"created-by-other","created-by-me"):util.changeOrAddClass(f,"created-by-me","created-by-other")}},
updateNodeInfo:function(a){util.json("getNodePrivileges",{nodeId:a.id,includeAcl:!1,includeOwners:!0}).done(function(c){b.updateNodeInfoResponse(c,a)})},getNodeFromId:function(a){return b.idToNodeMap[a]},getPathOfUid:function(a){var c=b.uidToNodeMap[a];return c?c.path:"[path error. invalid uid: "+a+"]"},addClickListeners:function(){$("#openLoginPgButton").on("click",user.openLoginPg);$("#navHomeButton").on("click",nav.navHome);$("#navUpLevelButton").on("click",nav.navUpLevel);$("#deletePropertyButton").on("click",
props.deleteProperty);$("#editModeButton").on("click",edit.editMode);$("#makeNodeReferencableButton").on("click",edit.makeNodeReferencable)},openDonatePg:function(){meta64.changePage("#donatePg")},getHighlightedNode:function(){return b.parentUidToFocusNodeMap[b.currentNodeUid]},highlightRowById:function(a,c){var e=b.getNodeFromId(a);e?b.highlightNode(e,c):console.log("highlightRowById failed to find id: "+a)},highlightNode:function(a,c){if(a){var e=!1,d=b.parentUidToFocusNodeMap[b.currentNodeUid];
d&&(d.uid===a.uid?e=!0:(d=d.uid+"_row",d=$("#"+d),util.changeOrAddClass(d,"active-row","inactive-row")));e||(b.parentUidToFocusNodeMap[b.currentNodeUid]=a,d=a.uid+"_row",d=$("#"+d),util.changeOrAddClass(d,"inactive-row","active-row"));c&&view.scrollToSelectedNode()}},refreshAllGuiEnablement:function(){util.getPropertyCount(b.selectedNodes);var a=b.getHighlightedNode();util.setEnablement($("#navHomeButton"),b.currentNode&&!nav.displayingHome());util.setEnablement($("#navUpLevelButton"),b.currentNode&&
nav.parentVisibleToUser());var c=b.currentNode&&!b.isAnonUser;util.setEnablement($("#propsToggleButton"),c);util.setEnablement($("#deletePropertyButton"),!b.isAnonUser);c=b.currentNode&&!b.isAnonUser;util.setEnablement($("#editModeButton"),c);util.setEnablement($("#insNodeButton"),!b.isAnonUser&&null!=a);util.setEnablement($("#createNodeButton"),!b.isAnonUser&&null!=a);util.setVisibility("#menuButton",!b.isAnonUser);util.setVisibility("#openSignupPgButton",b.isAnonUser);util.setVisibility("#mainMenuSearchButton",
!b.isAnonUser&&null!=a);util.setVisibility("#mainMenuTimelineButton",!b.isAnonUser&&null!=a)},getSingleSelectedNode:function(){for(var a in b.selectedNodes)if(b.selectedNodes.hasOwnProperty(a))return b.uidToNodeMap[a];return null},getOrdinalOfNode:function(a){if(!b.currentNodeData||!b.currentNodeData.children)return-1;for(var c=0;c<b.currentNodeData.children.length;c++)if(a.id===b.currentNodeData.children[c].id)return c;return-1},setCurrentNodeData:function(a){b.currentNodeData=a;b.currentNode=a.node;
b.currentNodeUid=a.node.uid;b.currentNodeId=a.node.id;b.currentNodePath=a.node.path},anonPageLoadResponse:function(a){a.renderNodeResponse?(util.setVisibility("#mainNodeContent",!0),util.setVisibility("#mainNodeStatusBar",!0),render.renderPageFromData(a.renderNodeResponse),b.refreshAllGuiEnablement()):(util.setVisibility("#mainNodeContent",!1),util.setVisibility("#mainNodeStatusBar",!1),console.log("setting listview to: "+a.content),util.setHtmlEnhanced($("#listView"),a.content));render.renderMainPageControls()},
initNode:function(a){a?(a.uid=util.getUidForId(b.identToUidMap,a.id),a.properties=props.setPreferredPropertyOrder(a.properties),b.uidToNodeMap[a.uid]=a,b.idToNodeMap[a.id]=a):console.log("initNode has null node")},initConstants:function(){util.addAll(b.simpleModePropertyBlackList,[jcrCnst.PRIMARY_TYPE,jcrCnst.POLICY]);util.addAll(b.readOnlyPropertyList,[jcrCnst.UUID,jcrCnst.MIXIN_TYPES,jcrCnst.CREATED,jcrCnst.CREATED_BY,jcrCnst.LAST_MODIFIED,jcrCnst.LAST_MODIFIED_BY,jcrCnst.IMG_WIDTH,jcrCnst.IMG_HEIGHT,
jcrCnst.BIN_VER,jcrCnst.BIN_DATA,jcrCnst.BIN_MIME]);util.addAll(b.binaryPropertyList,[jcrCnst.BIN_DATA])},initApp:function(){d||(console.log("initApp running."),d=!0,b.initConstants(),b.displaySignupMessage(),$(window).on("orientationchange",b.orientationHandler),b.addClickListeners(),b.deviceWidth=$(window).width(),b.deviceHeight=$(window).height(),user.refreshLogin(),pageMgr.initializePageBuilders(),setInterval(function(){var a=$(window).width();a!=b.deviceWidth&&(b.deviceWidth=a,b.deviceHeight=
$(window).height(),b.screenSizeChange())},1500),b.refreshAllGuiEnablement())},displaySignupMessage:function(){"ok"===$("#signupCodeResponse").text()&&alert("Signup complete. You may now login.")},screenSizeChange:function(){b.currentNodeData&&$.each(b.currentNodeData.children,function(a,c){c.imgId&&render.adjustImageSize(c)})},orientationHandler:function(a){},loadAnonPageHome:function(a){util.json("anonPageLoad",{ignoreUrl:a},b.anonPageLoadResponse)}};console.log("Module ready: meta64.js");return b}();console.log("running module: nav.js");
...
var confirmPg=function(){var d,b,a,c;console.log("Module ready: confirmPg.js");return{areYouSure:function(e,g,f,h){d=e;b=g;a=f;c=h;meta64.changePage("#confirmPg")},build:function(){var a;a="<h3 id='confirmPgTitle'></h3><p id='confirmPgMessage'></p>"+render.makeBackButton("Yes","confirmPgYesButton","b");a+=render.makeBackButton("No","confirmPgNoButton","a");a=render.makeTag("div",{"data-role":"content"},a);util.setHtmlEnhanced($("#confirmPg"),a)},init:function(){$("#confirmPgTitle").text(d);$("#confirmPgMessage").text(b);
...
a)}var a={build:function(){var a=b("Change Password","changePasswordPgButton","user.changePasswordPg();")+b("Preferences","accountPreferencesPgButton","prefs.accountPreferencesPg();")+b("Insert Book: War and Peace","insertBookWarAndPeaceButton"," edit.insertBookWarAndPeace();")+b("Donate","donatePgButton","meta64.openDonatePg();"),a=d("My Account",a),e=b("Attachments","manageAttachmentsButton","attachment.openUploadPg();")+b("Sharing","editNodeSharingButton","share.editNodeSharing();")+b("Move","moveSelNodesButton",
"edit.moveSelNodes();")+b("Finish Moving","finishMovingSelNodesButton","edit.finishMovingSelNodes();")+b("Export","openExportPgButton","edit.openExportPg();")+b("Import","openImportPgButton","edit.openImportPg();")+b("Delete","deleteSelNodesButton","edit.deleteSelNodes();"),e=d("Edit",e),g=b("Toggle Properties","propsToggleButton","props.propsToggle();")+b("Refresh","refreshPageButton","view.refreshPage();"),g=d("View Options",g),a=render.makeTag("div",{style:"margin: 0; min-width: 300px; position: fixed; top: 2em; left: 2em;",
"data-role":"collapsible-set"},a+e+g);util.setHtmlEnhanced($("#popupMenuPg"),a)},init:function(){var c=util.getPropertyCount(meta64.selectedNodes),b=meta64.getHighlightedNode(),d=!util.nullOrUndef(edit.nodesToMove)&&!a.isAnonUser;util.setEnablement($("#changePasswordPgButton"),!meta64.isAnonUser);util.setEnablement($("#accountPreferencesPgButton"),!meta64.isAnonUser);util.setEnablement($("#insertBookWarAndPeaceButton"),meta64.isAdminUser&&null!=b,meta64.isAdminUser);util.setEnablement($("#donatePgButton"),
!0);util.setEnablement($("#manageAttachmentsButton"),null!=b);util.setEnablement($("#editNodeSharingButton"),null!=b);util.setEnablement($("#moveSelNodesButton"),null!=b);util.setEnablement($("#finishMovingSelNodesButton"),d);util.setEnablement($("#openExportPgButton"),meta64.isAdminUser,meta64.isAdminUser);util.setEnablement($("#openImportPgButton"),meta64.isAdminUser,meta64.isAdminUser);util.setEnablement($("#deleteSelNodesButton"),c)}};console.log("Module ready: popupMenuPg.js");return a}();console.log("running module: prefsPg.js");
...
var props=function(){var d=function(a){util.checkSuccess("Save properties",a);edit.editNode.properties.push(a.propertySaved);meta64.changePage("#editNodePg");meta64.treeDirty=!0},b={propsToggle:function(){meta64.showProperties=meta64.showProperties?!1:!0;var a=$("#propsToggleButton");a.toggleClass("ui-icon-grid",meta64.showProperties);a.toggleClass("ui-icon-forbidden",!meta64.showProperties);render.renderPageFromData();view.scrollToSelectedNode();meta64.changePage("#mainPage")},deleteProperty:function(a){confirmPg.areYouSure("Confirm Delete",
...
edit.editNode.properties.length;c++)if(a===edit.editNode.properties[c].name){edit.editNode.properties.splice(c,1);break}},makeMultiPropEditor:function(a,c,b,d){var f="",h=c.values;h&&0!=h.length||(h=[],h.push(""));for(var k=0;k<h.length;k++){console.log("prop multi-val["+k+"]="+h[k]);var m=a+"_subProp"+k,f=f+render.makeTag("label",{"for":m},(0==k?c.name:"*")+"."+k),n=d?"[binary]":h[k],f=d||b?f+render.makeTag("textarea",{id:m,readonly:"readonly",disabled:"disabled"},n?n:""):f+render.makeTag("textarea",
{id:m},n?n:"")}return f},setPreferredPropertyOrder:function(a){if(a){var c=[];$.each(a,function(a,b){b.name===jcrCnst.CONTENT?c.unshift(b):c.push(b)});return c}},renderProperties:function(a){if(a){var c="<table data-role='table' class='prop-table ui-responsive ui-shadow table-stripe property-text'>",b=0,c=c+"<thead><tr><th></th><th></th></tr></thead>",c=c+"<tbody>";$.each(a,function(a,d){if(render.allowPropertyToDisplay(d.name)){var h=render.isBinaryProperty(d.name);b++;c+="<tr class='prop-table-row'>";
...
c.properties[b];if(d.name===a)return d}return null},getNodePropertyVal:function(a,c){var e=b.getNodeProperty(a,c);return e?e.value:null},renderProperty:function(a){return a.values?b.renderPropertyValues(a.values):a.value&&0!=a.value.length?render.markdown(a.value):""},renderPropertyValues:function(a){var b="<div>";$.each(a,function(a,d){b+=render.markdown(d)+cnst.BR});return b+="</div>"}};console.log("Module ready: props.js");return b}();console.log("running module: render.js");
var render=function(){var d,b={renderNodeContent:function(a,c,e,d,f){var h="",k;k=""+b.getTopRightImageTag(a);e&&meta64.editMode&&(h+="<div class='path-display'>Path: "+b.formatPath(a)+"</div>",h+="<div>",a.createdBy&&(h+="<span class='"+(a.createdBy===meta64.userName?"created-by-me":"created-by-other")+"'>Created By: "+a.createdBy+"</span>"),h+="<span id='ownerDisplay"+a.uid+"'></span>",a.lastModified&&(h+="  Modified: "+a.lastModified),h+="</div>");!c||!meta64.editMode||a.id===a.path&&e||(h+="ID: "+
a.id+cnst.BR);d&&!e&&a.name&&(h+="Name: "+a.name+" [uid="+a.uid+"]");h&&(k+=b.makeTag("div",{"class":"header-text"},h));if(meta64.showProperties)(c=props.renderProperties(a.properties))&&(k+=c);else if(c=props.getNodeProperty(jcrCnst.CONTENT,a))c=props.renderProperty(c),0<c.length&&(k+=b.makeTag("div",{"class":"jcr-content"},b.markdown(c)));f&&a.hasBinary&&(a.binaryIsImage?a=b.makeImageTag(a):(a=b.makeTag("a",{href:b.getUrlForNodeAttachment(a)},"[Download Attachment]"),a=b.makeTag("div",{"class":"binary-link"},
a)),k=k.contains(cnst.INSERT_ATTACHMENT)?k.replaceAll(cnst.INSERT_ATTACHMENT,a):k+a);return k},renderNodeAsListItem:function(a,c,e,d){var f=a.uid,h=a.id===meta64.newChildNodeId;d=0<c&&1<d;c=c<e-1;e=a.name.startsWith("rep:")||meta64.currentNodeData.node.path.contains("/rep:");e=meta64.isAdminUser||!e;var k=meta64.getHighlightedNode();!h&&k&&k.uid===f&&(h=!0);d=b.makeRowButtonBarHtml(f,d,c,e);return b.makeTag("div",{"class":"node-table-row"+(h?" active-row":" inactive-row"),onClick:"nav.clickOnNodeRow(this, '"+
f+"');",id:f+"_row"},d+b.makeTag("div",{id:f+"_content"},b.renderNodeContent(a,!0,!0,!0,!0)))},getTopRightImageTag:function(a){a=props.getNodePropertyVal("img.top.right",a);var c="";a&&(c=b.makeTag("img",{src:a,"class":"top-right-image"},"",!1));return c},makeRowButtonBarHtml:function(a,c,d,g){var f=selButton=createSubNodeButton=editNodeButton=moveNodeUpButton=moveNodeDownButton=insertNodeButton="";b.nodeHasChildren(a)&&(f=b.makeTag("a",{onClick:"nav.openNode('"+a+"');","class":"ui-btn ui-btn-b ui-btn-inline ui-icon-plus ui-mini ui-btn-icon-left"},
"Open"));meta64.editMode&&(selButton=b.makeTag("a",{id:a+"_sel",onClick:"nav.toggleNodeSel('"+a+"');","class":"ui-btn ui-btn-inline ui-icon-check ui-mini ui-btn-icon-left "+(meta64.selectedNodes[a]?"ui-btn-b":"ui-btn-a")},"Sel"),cnst.NEW_ON_TOOLBAR&&(createSubNodeButton=b.makeTag("a",{onClick:"edit.createSubNode('"+a+"');","class":"ui-btn ui-btn-inline ui-icon-star ui-mini ui-btn-icon-left"},"New")),cnst.INS_ON_TOOLBAR&&(insertNodeButton=b.makeTag("a",{onClick:"edit.insertNode('"+a+"');","class":"ui-btn ui-btn-inline ui-icon-bars ui-mini ui-btn-icon-left"},
"Ins")));meta64.editMode&&g&&(editNodeButton=b.makeTag("a",{onClick:"edit.runEditNode('"+a+"');","class":"ui-btn ui-btn-inline ui-icon-edit ui-mini ui-btn-icon-left"},"Edit"),meta64.currentNode.childrenOrdered&&(c&&(moveNodeUpButton=b.makeTag("a",{onClick:"edit.moveNodeUp('"+a+"');","class":"ui-btn ui-btn-inline ui-icon-arrow-u ui-mini ui-btn-icon-left"},"Up")),d&&(moveNodeDownButton=b.makeTag("a",{onClick:"edit.moveNodeDown('"+a+"');","class":"ui-btn ui-btn-inline ui-icon-arrow-d ui-mini ui-btn-icon-left"},
"Dn"))));a=selButton+f+insertNodeButton+createSubNodeButton+editNodeButton+moveNodeUpButton+moveNodeDownButton;return 0<a.length?b.makeHorizontalFieldSet(a,"compact-field-contain"):""},makeHorizontalFieldSet:function(a,c){var d=b.makeTag("fieldset",{"data-role":"controlgroup","data-type":"horizontal"},a);return b.makeTag("div",{"class":"ui-field-contain"+(c?" "+c:"")},d)},makeHorzControlGroup:function(a){return b.makeTag("div",{"data-role":"controlgroup","data-type":"horizontal"},a)},makeRadioButton:function(a,
c,d,g){return b.makeTag("input",{type:"radio",name:c,id:d,checked:g?"checked":"unchecked"},"",!0)+b.makeTag("label",{"for":d},a)},nodeHasChildren:function(a){var b=meta64.uidToNodeMap[a];if(b)return b.hasChildren;console.log("Unknown nodeId in nodeHasChildren: "+a);return!1},formatPath:function(a){var b=a.path,b=meta64.isAdminUser?b:b.replaceAll("/root","");return b+=" ["+a.primaryTypeName+"]"},markdown:function(a){d||(d=(new Markdown.getSanitizingConverter).makeHtml);return"<div data-ajax='false'>"+
d(a)+"</div>"},renderMainPageControls:function(){var a="";0<srch.numSearchResults()&&(a+=render.makeTag("a",{onClick:"nav.showSearchPage();","class":"ui-btn ui-btn-inline ui-icon-search ui-btn-icon-left"},"Back to Search Results"));var b=0<a.length;b&&util.setHtmlEnhanced($("#mainPageControls"),a);util.setVisibility("#mainPageControls",b)},renderPageFromData:function(a){var c=!1;a?c=!0:a=meta64.currentNodeData;if(a&&a.node){util.setVisibility("#listView",!0);b.renderMainPageControls();meta64.treeDirty=
!1;c&&(meta64.uidToNodeMap={},meta64.idToNodeMap={},meta64.selectedNodes={},meta64.initNode(a.node),meta64.setCurrentNodeData(a));var d="",g=b.renderNodeContent(a.node,!0,!0,!0,!0);if(0<g.length){var f=a.node.uid,g=b.makeTag("div",{"class":"node-table-row inactive-row",onClick:"nav.clickOnNodeRow(this, '"+f+"');",id:f+"_row"},g);$("#mainNodeContent").show();$("#mainNodeContent").html(g)}else $("#mainNodeContent").hide();view.updateStatusBar();b.renderMainPageControls();if(a.children){var h=a.children.length,
k=0;$.each(a.children,function(a,f){var g=b.generateRow(a,f,c,h,k);0!=g.length&&(d+=g,k++)})}0!=d.length||meta64.isAnonUser||(d=b.makeTag("a",{onClick:"edit.createSubNode();","class":"ui-btn ui-btn-inline ui-icon-star ui-btn-icon-left"},"Create Content"));util.setHtmlEnhancedById("#listView",d);meta64.getHighlightedNode()||util.scrollToTop()}else util.setVisibility("#listView",!1),$("#mainNodeContent").html("No default content is available.")},generateRow:function(a,c,d,g,f){if(meta64.isNodeBlackListed(c))return"";
d&&meta64.initNode(c);f++;return b.renderNodeAsListItem(c,a,g,f)},getUrlForNodeAttachment:function(a){return postTargetUrl+"bin?nodeId="+encodeURIComponent(a.path)+"&ver="+a.binVer},adjustImageSize:function(a){var b=$("#"+a.imgId);if(b){var d=b.attr("width"),g=b.attr("height");a.width&&a.height&&(a.width>meta64.deviceWidth-50?(d=meta64.deviceWidth-50,g=d*a.height/a.width,b.attr("width",d),b.attr("height",g)):(b.attr("width",a.width),b.attr("height",a.height)))}},makeImageTag:function(a){var c=b.getUrlForNodeAttachment(a);
a.imgId="imgUid_"+a.uid;if(a.width&&a.height){if(a.width>meta64.deviceWidth-50){var d=meta64.deviceWidth-50;return b.makeTag("img",{src:c,id:a.imgId,width:d+"px",height:d*a.height/a.width+"px"},null,!1)}return b.makeTag("img",{src:c,id:a.imgId,width:a.width+"px",height:a.height+"px"},null,!1)}return b.makeTag("img",{src:c,id:a.imgId},null,!1)},makeTag:function(a,b,d,g){"undefined"===typeof g&&(g=!0);var f="<"+a;b&&(f+=" ",$.each(b,function(a,b){f=b.contains("'")?f+(a+'="'+b+'" '):f+(a+"='"+b+"' ")}));
return f=g?f+(">"+d+"</"+a+">"):f+"/>"},makeEditField:function(a,c){return b.makeTag("label",{"for":c},a)+b.makeTag("input",{type:"text",name:c,id:c},"",!0)},makePasswordField:function(a,c){return b.makeTag("label",{"for":c},a)+b.makeTag("input",{type:"password",name:c,id:c},"",!0)},makeButton:function(a,b,d,g){d="ui-btn ui-btn-inline ui-btn-"+d;g&&(d+=" "+g);return render.makeTag("a",{id:b,"class":d},a)},makeBackButton:function(a,b,d){return render.makeTag("a",{id:b,"class":"ui-btn ui-icon-carat-l ui-btn-inline ui-btn-"+
...
var share=function(){var d=function(a){c.populateSharingPg(a)},b=function(a,b){var c="";$.each(b.privileges,function(b,d){var g=render.makeTag("a",{onClick:"share.removePrivilege('"+a+"', '"+d.privilegeName+"');","class":"ui-btn ui-btn-inline ui-icon-delete ui-btn-icon-left"},"Remove"),g=render.makeHorizontalFieldSet(g),g=g+("<b>"+a+"</b> has privilege <b>"+d.privilegeName+"</b> on this node.");c+=render.makeTag("div",{"class":"privilege-entry"},g)});return c},a=function(a){util.json("getNodePrivileges",
...
meta64.MODE_ADVANCED:meta64.MODE_SIMPLE},a=function(a,c,e,g){util.checkSuccess("Login",a)?("anonymous"!=c&&(f.writeCookie(cnst.COOKIE_LOGIN_USR,c),f.writeCookie(cnst.COOKIE_LOGIN_PWD,e)),meta64.changePage("#mainPage"),b(a),view.refreshTree(util.emptyString(a.homeNodeOverride)?meta64.homeNodeId:a.homeNodeOverride,!1),d(a)):g&&(alert("Cookie login failed."),$.removeCookie(cnst.COOKIE_LOGIN_USR),$.removeCookie(cnst.COOKIE_LOGIN_PWD),location.reload())},c=function(a){meta64.changePage("#mainPage");location.reload()},
e=function(a){util.checkSuccess("Change password",a)&&alert("Password changed successfully.")},g=function(a){util.checkSuccess("Signup new user",a)&&(user.populateLoginPgFromCookies(),meta64.changePage("#loginPg"),alert("User Information Accepted. \n\nCheck your email for signup confirmation. (Can take up to 1 minute)"))},f={writeCookie:function(a,b){$.cookie(a,b,{expires:365,path:"/"})},populateLoginPgFromCookies:function(){var a=$.cookie(cnst.COOKIE_LOGIN_USR),b=$.cookie(cnst.COOKIE_LOGIN_PWD);
...
util.json("signup",{userName:a,password:b,email:c,captcha:d},g)},pageInitSignupPg:function(){user.tryAnotherCaptcha()},tryAnotherCaptcha:function(){var a=util.currentTimeMillis(),a=postTargetUrl+"captcha?t="+a;$("#captchaImage").attr("src",a)},refreshLogin:function(){var c=$.cookie(cnst.COOKIE_LOGIN_USR),e=$.cookie(cnst.COOKIE_LOGIN_PWD),g=!util.emptyString(c)&&!util.emptyString(e),f=c?c:"{session}",p=e?e:"{session}",c=util.json("login",{userName:f,password:p,usingCookies:g,tzOffset:(new Date).getTimezoneOffset(),
dst:util.daylightSavingsTime});g?c.done(function(b){a(b,f,p,g)}):c.done(function(a){b(a);d(a);meta64.loadAnonPageHome(!1)})},login:function(){var b=$.trim($("#userName").val()),c=$.trim($("#password").val());util.json("login",{userName:b,password:c,tzOffset:(new Date).getTimezoneOffset(),dst:util.daylightSavingsTime}).done(function(d){a(d,b,c)})},logout:function(){$.removeCookie(cnst.COOKIE_LOGIN_USR);$.removeCookie(cnst.COOKIE_LOGIN_PWD);util.json("logout",{},c)},changePassword:function(){var a=
util.getRequiredElement("#changePassword1").val(),b=util.getRequiredElement("#changePassword2").val();a&&4<=a.length&&a===b?util.json("changePassword",{newPassword:a},e):alert("Sorry, invalid password(s).")},changePasswordPg:function(){meta64.changePage("#changePasswordPg")}};console.log("Module ready: user.js");return f}();console.log("running module: util.js");
...
b,d){if(a.className&&0!=a.className.length){for(var g=a.className.split(" "),f="",h=!1,k=0;k<g.length;k++){var m=g[k];if(m===d){if(h)continue;h=!0}else if(m===b){if(h)continue;m=d;h=!0}0<f.length&&(f+=" ");f+=m}h||(0<f.length&&(f+=" "),f+=d);a.className=f}else console.log("no existing className is available on element, so assigning to "+d),a.className=d},verifyType:function(a,b,d){return typeof a!==b?(alert(d),!1):!0},setHtmlEnhancedById:function(a,c){var d=b.getRequiredElement(a);d?($(d).html(c),
...
function(a,d){0<b.length&&(b+=",");b+=a});return b},setVisibility:function(a,b){b?$(a).show():$(a).hide()}};console.log("Module ready: util.js");return b}();console.log("running module: view.js");
...
d.scrollToSelectedNode();meta64.refreshAllGuiEnablement()},refreshTree:function(b,a){b||(b=meta64.currentNodeId);util.json("renderNode",{nodeId:b,renderParentIfLeaf:a?!0:!1}).done(function(c){d.refreshTreeResponse(c,b,a)})},refreshPage:function(){meta64.changePage("#mainPage");view.refreshTree(null,!1)},scrollToSelectedNode:function(){setTimeout(function(){var b=nav.getSelectedDomElement();if(b){var a=meta64.getHighlightedNode(),b=0==meta64.getOrdinalOfNode(a)?0:$("#"+b.id).offset().top-$("#mainPageHeader").height();
$("html, body").animate({scrollTop:b})}},1E3)},initEditPathDisplayById:function(b){var a=edit.editNode;b=$(b);edit.editingUnsavedNode?b.hide():(b.html("Path: "+render.formatPath(a)),b.show())}};console.log("Module ready: view.js");return d}();
