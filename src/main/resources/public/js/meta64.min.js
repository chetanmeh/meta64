...
b,c,d)?alert("Sorry, you cannot leave any fields blank."):util.json("signup",{userName:a,password:b,email:c,captcha:d},g)},pageInitSignupPg:function(){user.tryAnotherCaptcha()},tryAnotherCaptcha:function(){var a=util.currentTimeMillis(),a=postTargetUrl+"captcha?t="+a;$("#captchaImage").attr("src",a)},refreshLogin:function(){var b=$.cookie(cnst.COOKIE_LOGIN_USR),d=$.cookie(cnst.COOKIE_LOGIN_PWD),f=!util.emptyString(b)&&!util.emptyString(d),b=b?b:"{session}",d=d?d:"{session}";util.json("login",{userName:b,
