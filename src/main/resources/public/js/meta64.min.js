...
var edit=function(){var d,b,a=function(a){util.checkSuccess("Save node",a);view.refreshTree(null,!1);meta64.jqueryChangePage("#mainPage");view.scrollToSelectedNode()},c=function(a){util.checkSuccess("Rename node",a);view.refreshTree(null,!1);meta64.jqueryChangePage("#mainPage");view.scrollToSelectedNode()},f=function(a){util.checkSuccess("Export",a)&&(alert("Export Successful."),meta64.jqueryChangePage("#mainPage"),view.scrollToSelectedNode())},g=function(a){util.checkSuccess("Import",a)&&(alert("Import Successful."),
view.refreshTree(null,!1),meta64.jqueryChangePage("#mainPage"),view.scrollToSelectedNode())},e=function(a){console.log("insertBookResponse running.");util.checkSuccess("Insert Book",a);view.refreshTree(null,!1);meta64.jqueryChangePage("#mainPage");view.scrollToSelectedNode()},h=function(a){util.checkSuccess("Delete node",a)&&(meta64.clearSelectedNodes(),view.refreshTree(null,!1))},l=function(a){util.checkSuccess("Move nodes",a);k.nodesToMove=null;view.refreshTree(null,!1)},m=function(a){util.checkSuccess("Change node position",
...
meta64.newChildNodeId);meta64.initNode(a.newNode);edit.runEditNode(a.newNode.uid)},k={nodesToMove:null,editingUnsavedNode:!1,editNode:null,nodeInsertTarget:null,startEditingNewNode:function(){k.editingUnsavedNode=!1;k.editNode=null;k.saveNewNode("")},startEditingNewNodeWithName:function(){k.editingUnsavedNode=!0;k.editNode=null;meta64.changePage(editNodePg)},editMode:function(){meta64.editMode=meta64.editMode?!1:!0;var a=$("#editModeButton");a.toggleClass("ui-icon-edit",meta64.editMode);a.toggleClass("ui-icon-forbidden",
!meta64.editMode);render.renderPageFromData();view.scrollToSelectedNode()},makeNodeReferencable:function(){util.json("makeNodeReferencable",{nodeId:k.editNode.id},p)},cancelEdit:function(){meta64.treeDirty&&view.refreshTree(null,!1);meta64.jqueryChangePage("#mainPage");view.scrollToSelectedNode()},saveNode:function(){k.editingUnsavedNode?k.saveNewNode():k.saveExistingNode()},saveNewNode:function(a){a||(a=util.getRequiredElement("#newNodeNameId").val());meta64.userName!=d.createdBy&&"admin"!=d.createdBy&&
(b=!0);meta64.treeDirty=!0;k.nodeInsertTarget?util.json("insertNode",{parentId:d.id,targetName:k.nodeInsertTarget.name,newNodeName:a},n):util.json("createSubNode",{nodeId:d.id,newNodeName:a},q)},saveExistingNode:function(){for(var c=[],f=0,d=0;;){var h="editNodeTextContent"+f;if(meta64.fieldIdToPropMap.hasOwnProperty(h)){var g=meta64.fieldIdToPropMap[h],h=$("#"+h).val();h!==g.value&&(c.push({name:g.name,value:h}),d++)}else break;f++}0<d?(util.json("saveNode",{nodeId:k.editNode.id,properties:c,sendNotification:b},
...
newName:a},c):alert("Select a node to rename.")}},exportNodes:function(){var a=meta64.getHighlightedNode(),c=util.getRequiredElement("#exportTargetNodeName").val();util.emptyString(c)?alert("Please enter a name for the export file."):a&&util.json("exportToXml",{nodeId:a.id,targetFileName:c},f)},openImportPg:function(){meta64.changePage(importPg)},importNodes:function(){var a=meta64.getHighlightedNode(),c=util.getRequiredElement("#importTargetNodeName").val();util.emptyString(c)?alert("Please enter a name for the import file."):
a&&util.json("import",{nodeId:a.id,sourceFileName:c},g)},runEditNode:function(a){var c=meta64.uidToNodeMap[a];c?(k.editingUnsavedNode=!1,k.editNode=c,meta64.changePage(editNodePg)):(k.editNode=null,alert("Unknown nodeId in editNodeClick: "+a))},populateEditNodePg:function(){view.initEditPathDisplayById("#editNodePathDisplay");var a="",c=0;meta64.fieldIdToPropMap={};if(k.editNode)$.each(k.editNode.properties,function(b,f){if(render.allowPropertyToDisplay(f.name)){var d="editNodeTextContent"+c;meta64.fieldIdToPropMap[d]=
f;var h=f.values&&0<f.values.length,g=render.isReadOnlyProperty(f.name),e=render.isBinaryProperty(f.name);if(g||e)d="RdOnly_"+d;var l="";if(!g&&!e){var l=render.makeTag("a",{onClick:"props.clearProperty('"+d+"');","class":"ui-btn ui-btn-inline ui-icon-back ui-btn-icon-left"},"Clear"),k="",m="";f.name!==jcrCnst.CONTENT&&(m=render.makeTag("a",{onClick:"props.deleteProperty('"+f.name+"');","class":"ui-btn ui-btn-inline ui-icon-delete ui-btn-icon-left"},"Del"),k=render.makeTag("a",{onClick:"props.addSubProperty('"+
d+"');","class":"ui-btn ui-btn-inline ui-icon-star ui-btn-icon-left"},"Add Multi"));l=k+l+m;l=0<l.length?render.makeHorizontalFieldSet(l,"property-edit-button-bar"):""}h?(console.log("Property multi-type: name="+f.name+" count="+f.values.length),l+=props.makeMultiPropEditor(d,f,g,e)):(console.log("Property single-type: "+f.name),l+=render.makeTag("label",{"for":d},render.sanitizePropertyName(f.name)),h=e?"[binary]":f.value,l=g||e?l+render.makeTag("textarea",{id:d,readonly:"readonly",disabled:"disabled"},
h?h:""):l+render.makeTag("textarea",{id:d},h?h:""));a+=render.makeTag("div",{"class":"ui-field-contain property-edit-field"},l);c++}else console.log("Hiding property: "+f.name)});else var b=render.makeTag("label",{"for":"newNodeNameId"},"New Node Name")+render.makeTag("textarea",{id:"newNodeNameId"},""),a=a+render.makeTag("div",{"class":"ui-field-contain property-edit-field"},b);util.setHtmlEnhanced($("#propertyEditFieldContainer"),a);b=k.editingUnsavedNode?"You may leave this field blank and a unique ID will be assigned. You only need to provide a name if you want this node to have a more meaningful URL.":
"";$("#editNodeInstructions").html(b);util.setVisibility("#addPropertyButton",!k.editingUnsavedNode);b=k.editNode&&k.editNode.id&&!k.editNode.id.startsWith("/");util.setVisibility("#makeNodeReferencableButton",k.editNode&&!b&&!k.editingUnsavedNode)},insertNode:function(a){if(d=meta64.currentNode){var c=null;if(c=a?meta64.uidToNodeMap[a]:meta64.getHighlightedNode())k.nodeInsertTarget=c,k.startEditingNewNode()}else console.log("Unknown parent")},createSubNodeUnderHighlight:function(){(d=meta64.getHighlightedNode())?
(k.nodeInsertTarget=null,k.startEditingNewNode()):alert("Tap a node to insert under.")},createSubNode:function(a){if(a){if(d=meta64.uidToNodeMap[a],!d){console.log("Unknown nodeId in createSubNode: "+a);return}}else d=meta64.currentNode;k.nodeInsertTarget=null;k.startEditingNewNode()},clearSelections:function(){meta64.clearSelectedNodes();render.renderPageFromData();meta64.jqueryChangePage("#mainPage")},deleteSelNodes:function(){var a=meta64.getSelectedNodeIdsArray();a&&0!=a.length?confirmPg.areYouSure("Confirm Delete",
"Delete "+a.length+" node(s) ?","Yes, delete.",function(){util.json("deleteNodes",{nodeIds:a},h)}):alert("You have not selected any nodes. Select nodes to delete first.")},moveSelNodes:function(){var a=meta64.getSelectedNodeIdsArray();a&&0!=a.length?confirmPg.areYouSure("Confirm Move","Move "+a.length+" node(s) to a new location ?","Yes, move.",function(){k.nodesToMove=a;meta64.selectedNodes={};alert("Ok, ready to move nodes. To finish moving, go select the target location, then click 'Finish Moving'");
meta64.refreshAllGuiEnablement()}):alert("You have not selected any nodes. Select nodes to delete first.")},finishMovingSelNodes:function(){confirmPg.areYouSure("Confirm Move","Move "+k.nodesToMove.length+" node(s) to selected location ?","Yes, move.",function(){var a=meta64.getHighlightedNode();util.json("moveNodes",{targetNodeId:a.id,targetChildId:null!=a?a.id:null,nodeIds:k.nodesToMove},l)})},insertBookWarAndPeace:function(){confirmPg.areYouSure("Confirm","Insert book War and Peace?","Yes, insert book.",
function(){var a=meta64.getHighlightedNode();a?util.json("insertBook",{nodeId:a.id,bookName:"War and Peace"},e):alert("No node is selected.")})}};console.log("Module ready: edit.js");return k}();console.log("running module: jcrCnst.js");
...
$("#"+popupMenuPg.domId).popup("open")},isNodeBlackListed:function(a){if(!b.inSimpleMode())return!1;for(var c in b.simpleModeNodePrefixBlackList)if(b.simpleModeNodePrefixBlackList.hasOwnProperty(c)&&a.name.startsWith(c))return!0;return!1},getSelectedNodeUidsArray:function(){var a=[],c=0,f;for(f in b.selectedNodes)b.selectedNodes.hasOwnProperty(f)&&(a[c++]=f);return a},getSelectedNodeIdsArray:function(){var a=[],c=0,f;b.selectedNodes?console.log("selectedNode count: "+b.selectedNodes.length):console.log("no selected nodes.");
for(f in b.selectedNodes)if(b.selectedNodes.hasOwnProperty(f)){var d=b.uidToNodeMap[f];d?a[c++]=d.id:console.log("unable to find uidToNodeMap for uid="+f)}return a},getSelectedNodesArray:function(){var a=[],c=0,f;for(f in b.selectedNodes)b.selectedNodes.hasOwnProperty(f)&&(a[c++]=b.uidToNodeMap[f]);return a},clearSelectedNodes:function(){b.selectedNodes={}},updateNodeInfoResponse:function(a,c){var b="",d=!1;a.owners&&$.each(a.owners,function(a,c){0<b.length&&(b+=",");c===meta64.userName&&(d=!0);b+=
c});if(0<b.length){c.owner=b;var e=$("#ownerDisplay"+c.uid);e.html(" (Manager: "+b+")");d?util.changeOrAddClass(e,"created-by-other","created-by-me"):util.changeOrAddClass(e,"created-by-me","created-by-other")}},updateNodeInfo:function(a){util.json("getNodePrivileges",{nodeId:a.id,includeAcl:!1,includeOwners:!0}).done(function(c){b.updateNodeInfoResponse(c,a)})},getNodeFromId:function(a){return b.idToNodeMap[a]},getPathOfUid:function(a){var c=b.uidToNodeMap[a];return c?c.path:"[path error. invalid uid: "+
a+"]"},addClickListeners:function(){$("#openLoginPgButton").on("click",user.openLoginPg);$("#navHomeButton").on("click",nav.navHome);$("#navUpLevelButton").on("click",nav.navUpLevel);$("#deletePropertyButton").on("click",props.deleteProperty);$("#editModeButton").on("click",edit.editMode)},openDonatePg:function(){meta64.jqueryChangePage("#donatePg")},getHighlightedNode:function(){return b.parentUidToFocusNodeMap[b.currentNodeUid]},highlightRowById:function(a,c){var f=b.getNodeFromId(a);f?b.highlightNode(f,
c):console.log("highlightRowById failed to find id: "+a)},highlightNode:function(a,c){if(a){var f=!1,d=b.parentUidToFocusNodeMap[b.currentNodeUid];d&&(d.uid===a.uid?f=!0:(d=d.uid+"_row",d=$("#"+d),util.changeOrAddClass(d,"active-row","inactive-row")));f||(b.parentUidToFocusNodeMap[b.currentNodeUid]=a,d=a.uid+"_row",d=$("#"+d),util.changeOrAddClass(d,"inactive-row","active-row"));c&&view.scrollToSelectedNode()}},refreshAllGuiEnablement:function(){util.getPropertyCount(b.selectedNodes);var a=b.getHighlightedNode();
util.setEnablement($("#navHomeButton"),b.currentNode&&!nav.displayingHome());util.setEnablement($("#navUpLevelButton"),b.currentNode&&nav.parentVisibleToUser());var c=b.currentNode&&!b.isAnonUser;util.setEnablement($("#propsToggleButton"),c);util.setEnablement($("#deletePropertyButton"),!b.isAnonUser);c=b.currentNode&&!b.isAnonUser;util.setEnablement($("#editModeButton"),c);util.setEnablement($("#insNodeButton"),!b.isAnonUser&&null!=a);util.setEnablement($("#createNodeButton"),!b.isAnonUser&&null!=
a);util.setVisibility("#menuButton",!b.isAnonUser);util.setVisibility("#openSignupPgButton",b.isAnonUser);util.setVisibility("#mainMenuSearchButton",!b.isAnonUser&&null!=a);util.setVisibility("#mainMenuTimelineButton",!b.isAnonUser&&null!=a);util.setVisibility("#mainNavBar",!b.isAnonUser)},getSingleSelectedNode:function(){for(var a in b.selectedNodes)if(b.selectedNodes.hasOwnProperty(a))return b.uidToNodeMap[a];return null},getOrdinalOfNode:function(a){if(!b.currentNodeData||!b.currentNodeData.children)return-1;
for(var c=0;c<b.currentNodeData.children.length;c++)if(a.id===b.currentNodeData.children[c].id)return c;return-1},setCurrentNodeData:function(a){b.currentNodeData=a;b.currentNode=a.node;b.currentNodeUid=a.node.uid;b.currentNodeId=a.node.id;b.currentNodePath=a.node.path},anonPageLoadResponse:function(a){a.renderNodeResponse?(util.setVisibility("#mainNodeContent",!0),util.setVisibility("#mainNodeStatusBar",!0),render.renderPageFromData(a.renderNodeResponse),b.refreshAllGuiEnablement()):(util.setVisibility("#mainNodeContent",
!1),util.setVisibility("#mainNodeStatusBar",!1),console.log("setting listview to: "+a.content),util.setHtmlEnhanced($("#listView"),a.content));render.renderMainPageControls()},initNode:function(a){a?(a.uid=util.getUidForId(b.identToUidMap,a.id),a.properties=props.setPreferredPropertyOrder(a.properties),b.uidToNodeMap[a.uid]=a,b.idToNodeMap[a.id]=a):console.log("initNode has null node")},initConstants:function(){util.addAll(b.simpleModePropertyBlackList,[jcrCnst.PRIMARY_TYPE,jcrCnst.POLICY]);util.addAll(b.readOnlyPropertyList,
[jcrCnst.UUID,jcrCnst.MIXIN_TYPES,jcrCnst.CREATED,jcrCnst.CREATED_BY,jcrCnst.LAST_MODIFIED,jcrCnst.LAST_MODIFIED_BY,jcrCnst.IMG_WIDTH,jcrCnst.IMG_HEIGHT,jcrCnst.BIN_VER,jcrCnst.BIN_DATA,jcrCnst.BIN_MIME]);util.addAll(b.binaryPropertyList,[jcrCnst.BIN_DATA])},initApp:function(){d||(console.log("initApp running."),d=!0,b.initConstants(),b.displaySignupMessage(),$(window).on("orientationchange",b.orientationHandler),$(window).bind("beforeunload",function(){return"Leave Meta64 ?"}),$(window).on("unload",
function(){user.logout(!1)}),b.addClickListeners(),b.deviceWidth=$(window).width(),b.deviceHeight=$(window).height(),user.refreshLogin(),setInterval(function(){var a=$(window).width();a!=b.deviceWidth&&(b.deviceWidth=a,b.deviceHeight=$(window).height(),b.screenSizeChange())},1500),b.refreshAllGuiEnablement())},displaySignupMessage:function(){"ok"===$("#signupCodeResponse").text()&&alert("Signup complete. You may now login.")},screenSizeChange:function(){b.currentNodeData&&(meta64.currentNode.imgId&&
render.adjustImageSize(meta64.currentNode),$.each(b.currentNodeData.children,function(a,c){c.imgId&&render.adjustImageSize(c)}))},orientationHandler:function(a){},loadAnonPageHome:function(a){util.json("anonPageLoad",{ignoreUrl:a},b.anonPageLoadResponse)}};console.log("Module ready: meta64.js");return b}();console.log("running module: nav.js");
...
console.log("clickOnNodeRow recieved uid that doesn't map to any node. uid="+a)},openNode:function(b){var a=meta64.uidToNodeMap[b];meta64.highlightNode(a,!0);a?view.refreshTree(a.id,!1):alert("Unknown nodeId in openNode: "+b)},toggleNodeSel:function(b){if(util.getRequiredElement()){var a=$("#"+b+"_sel"),c=a.attr("class").contains("ui-btn-b");c?(util.changeOrAddClass(a,"ui-btn-b","ui-btn-a"),c=!1):(util.changeOrAddClass(a,"ui-btn-a","ui-btn-b"),c=!0);c?meta64.selectedNodes[b]=!0:delete meta64.selectedNodes[b];
...
var loginPg=function(){console.log("Module ready: loginPg.js");return{domId:"loginPg",build:function(){var d=render.makeTag("div",{"data-role":"header"},"<h2>"+BRANDING_TITLE+" - Login</h2>"),b=render.makeEditField("User","userName")+render.makePasswordField("Password","password"),a=render.makeButton("Login","loginButton","b","ui-btn-icon-left ui-icon-check"),c=render.makeBackButton("Close","cancelLoginButton","a"),a=render.makeHorzControlGroup(a+c),c=render.makeButton("Twitter","twitterLoginButton",
"a","ui-btn-icon-left ui-icon-user"),c=render.makeHorzControlGroup(c),b=render.makeTag("div",{"class":"ui-field-contain"},b+a),b=render.makeTag("div",{role:"main","class":"ui-content dialog-content"},""+b+"<div><h3>Or Login With...</h3></div>"+c),d=d+b;util.setHtmlEnhanced($("#loginPg"),d);$("#loginButton").on("click",user.login);$("#twitterLoginButton").on("click",user.twitterLogin);util.bindEnterKey("#userName",user.login);util.bindEnterKey("#password",user.login)},init:function(){user.populateLoginPgFromCookies();
util.delayedFocus("#userName")}}}();console.log("running module: messagePg.js");
var messagePg=function(){var d,b,a;console.log("Module ready: messagePg.js");return{domId:"messagePg",showMessage:function(c,f,g){d=c;b=f;a=g;meta64.openDialog(messagePg)},build:function(){var c;c="<h3 id='messagePgTitle'></h3><p id='messagePgMessage'></p>"+render.makeBackButton("Ok","messagePgOkButton","b");c=render.makeTag("div",{"data-role":"content"},c);util.setHtmlEnhanced($("#messagePg"),c);$("#messagePgOkButton").on("click",function(){a()})},init:function(){$("#messagePgTitle").text(d);$("#messagePgMessage").html(b);
...
a)}var a={domId:"popupMenuPg",build:function(){var a=b("Change Password","changePasswordPgButton","user.changePasswordPg();")+b("Preferences","accountPreferencesPgButton","prefs.accountPreferencesPg();")+b("Insert Book: War and Peace","insertBookWarAndPeaceButton"," edit.insertBookWarAndPeace();")+b("Donate","donatePgButton","meta64.openDonatePg();"),a=d("My Account",a),f=b("Attachments","manageAttachmentsButton","attachment.openUploadPg();")+b("Sharing","editNodeSharingButton","share.editNodeSharing();")+
b("Move","moveSelNodesButton","edit.moveSelNodes();")+b("Finish Moving","finishMovingSelNodesButton","edit.finishMovingSelNodes();")+b("Rename","renameNodePgButton","edit.openRenameNodePg();")+b("Delete","deleteSelNodesButton","edit.deleteSelNodes();")+b("Clear Selections","clearSelectionsButton","edit.clearSelections();")+b("Import","openImportPgButton","edit.openImportPg();")+b("Export","openExportPgButton","edit.openExportPg();"),f=d("Edit",f),g=b("Toggle Properties","propsToggleButton","props.propsToggle();")+
b("Refresh","refreshPageButton","view.refreshPage();")+b("Show URL","showFullNodeUrlButton","render.showNodeUrl();"),g=d("View Options",g),a=render.makeTag("div",{style:"margin: 0; min-width: 300px; position: fixed; top: 2em; left: 2em;","data-role":"collapsible-set"},a+f+g);util.setHtmlEnhanced($("#popupMenuPg"),a)},init:function(){var c=util.getPropertyCount(meta64.selectedNodes),b=meta64.getHighlightedNode(),d=!util.nullOrUndef(edit.nodesToMove)&&!a.isAnonUser;util.setEnablement($("#changePasswordPgButton"),
!meta64.isAnonUser);util.setEnablement($("#accountPreferencesPgButton"),!meta64.isAnonUser);util.setEnablement($("#insertBookWarAndPeaceButton"),meta64.isAdminUser&&null!=b,meta64.isAdminUser);util.setEnablement($("#donatePgButton"),!0);util.setEnablement($("#manageAttachmentsButton"),null!=b&&!meta64.isAnonUser);util.setEnablement($("#editNodeSharingButton"),null!=b&&!meta64.isAnonUser);util.setEnablement($("#moveSelNodesButton"),null!=b&&!meta64.isAnonUser);util.setEnablement($("#renameNodePgButton"),
null!=b&&!meta64.isAnonUser);util.setEnablement($("#finishMovingSelNodesButton"),d,d);util.setEnablement($("#openExportPgButton"),meta64.isAdminUser,meta64.isAdminUser);util.setEnablement($("#openImportPgButton"),meta64.isAdminUser,meta64.isAdminUser);util.setEnablement($("#deleteSelNodesButton"),c)}};console.log("Module ready: popupMenuPg.js");return a}();console.log("running module: prefsPg.js");
...
c=render.makeBackButton("Cancel","cancelPreferencesPgButton","a"),a=render.makeHorzControlGroup(a+c),c=render.makeButton("Close Account","closeAccountButton","a"),c=render.makeHorzControlGroup(c),b=render.makeTag("div",{"class":"ui-field-contain"},b+a+c),b=render.makeTag("div",{role:"main","class":"ui-content dialog-content"},""+b),d=d+b;util.setHtmlEnhanced($("#prefsPg"),d);$("#savePreferencesButton").on("click",prefs.savePreferences);$("#closeAccountButton").on("click",prefs.closeAccount)}}}();console.log("running module: renameNodePg.js");
...
a),a=render.makeTag("div",{id:"uploadFieldContainer"},"<p>Upload from your computer</p>"+a),c=render.makeEditField("Upload From URL","uploadFromUrl"),c=render.makeTag("div",{},c),f=render.makeButton("Upload","uploadButton","b","ui-btn-icon-left ui-icon-check"),g=render.makeButton("Delete","deleteAttachmentButton","a"),e=render.makeBackButton("Close","closeUploadButton","a"),f=render.makeHorzControlGroup(f+g+e),b=render.makeTag("div",{role:"main","class":"ui-content dialog-content"},b+a+"<div><h3>-- OR --</h3></div>"+
c+f);util.setHtmlEnhanced($("#uploadPg"),d+b);$("#uploadButton").on("click",attachment.uploadFileNow);$("#deleteAttachmentButton").on("click",attachment.deleteAttachment)},init:function(){$("#uploadFromUrl").val("");$("#uploadPathDisplay").html("Path: "+render.formatPath(attachment.uploadNode))}}}();console.log("running module: prefs.js");
var prefs=function(){var d={savePreferencesResponse:function(b){util.checkSuccess("Saving Preferences",b)&&(meta64.jqueryChangePage("#mainPage"),view.scrollToSelectedNode())},closeAccountResponse:function(){$(window).off("beforeunload");window.location.href=window.location.origin},closeAccount:function(){confirmPg.areYouSure("Oh No!","Close your Account? Are you sure? This was so unexpected!","Yes, Close Account.",function(){util.json("closeAccount",{},d.closeAccountResponse)})},savePreferences:function(){meta64.editModeOption=
...
edit.editNode.properties.length;c++)if(a===edit.editNode.properties[c].name){edit.editNode.properties.splice(c,1);break}},makeMultiPropEditor:function(a,c,b,d){var e="",h=c.values;h&&0!=h.length||(h=[],h.push(""));for(var l=0;l<h.length;l++){console.log("prop multi-val["+l+"]="+h[l]);var m=a+"_subProp"+l,e=e+render.makeTag("label",{"for":m},(0==l?c.name:"*")+"."+l),n=d?"[binary]":h[l],e=d||b?e+render.makeTag("textarea",{id:m,readonly:"readonly",disabled:"disabled"},n?n:""):e+render.makeTag("textarea",
{id:m},n?n:"")}return e},setPreferredPropertyOrder:function(a){if(a){var c=[];$.each(a,function(a,b){b.name===jcrCnst.CONTENT?c.unshift(b):c.push(b)});return c}},renderProperties:function(a){if(a){var c="<table data-role='table' class='prop-table ui-responsive ui-shadow table-stripe property-text'>",b=0,c=c+"<thead><tr><th></th><th></th></tr></thead>",c=c+"<tbody>";$.each(a,function(a,d){if(render.allowPropertyToDisplay(d.name)){var h=render.isBinaryProperty(d.name);b++;c+="<tr class='prop-table-row'>";
c+="<td class='prop-table-name-col'>"+render.sanitizePropertyName(d.name)+"</td>";c=h?c+"<td class='prop-table-val-col'>[binary]</td>":d.values?c+("<td class='prop-table-val-col'>"+props.renderPropertyValues(d.values)+"</td>"):c+("<td class='prop-table-val-col'>"+render.markdown(d.value)+"</td>");c+="</tr>"}else console.log("Hiding property: "+d.name)});return 0==b?"":c+="</tbody></table>"}},getNodeProperty:function(a,c){if(!c||!c.properties)return null;for(var b=0;b<c.properties.length;b++){var d=
c.properties[b];if(d.name===a)return d}return null},getNodePropertyVal:function(a,c){var f=b.getNodeProperty(a,c);return f?f.value:null},renderProperty:function(a){return a.values?b.renderPropertyValues(a.values):a.value&&0!=a.value.length?render.markdown(a.value):""},renderPropertyValues:function(a){var c="<div>";$.each(a,function(a,b){c+=render.markdown(b)+cnst.BR});return c+="</div>"}};console.log("Module ready: props.js");return b}();console.log("running module: render.js");
var render=function(){var d,b={buildPage:function(a){a.built||(a.build(),a.built=!0);a.init&&a.init()},renderNodeContent:function(a,c,d,g){var e="",h;h=""+b.getTopRightImageTag(a);c&&meta64.editMode&&(e+="<div class='path-display'>Path: "+b.formatPath(a)+"</div>",e+="<div>",a.createdBy&&(e+="<span class='"+(a.createdBy===meta64.userName?"created-by-me":"created-by-other")+"'>Created By: "+a.createdBy+"</span>"),e+="<span id='ownerDisplay"+a.uid+"'></span>",a.lastModified&&(e+="  Modified: "+a.lastModified),
e+="</div>");d&&!c&&a.name&&(e+="Name: "+a.name+" [uid="+a.uid+"]");e&&(h+=b.makeTag("div",{"class":"header-text"},e));if(meta64.showProperties)(c=props.renderProperties(a.properties))&&(h+=c);else if(c=props.getNodeProperty(jcrCnst.CONTENT,a))c=props.renderProperty(c),0<c.length&&(h+=b.makeTag("div",{"class":"jcr-content"},b.markdown(c)));g&&a.hasBinary&&(a.binaryIsImage?a=b.makeImageTag(a):(a=b.makeTag("a",{href:b.getUrlForNodeAttachment(a)},"[Download Attachment]"),a=b.makeTag("div",{"class":"binary-link"},
a)),h=h.contains(cnst.INSERT_ATTACHMENT)?h.replaceAll(cnst.INSERT_ATTACHMENT,a):h+a);return h},renderNodeAsListItem:function(a,c,d,g){var e=a.uid,h=a.id===meta64.newChildNodeId;g=0<c&&1<g;c=c<d-1;d=a.name.startsWith("rep:")||meta64.currentNodeData.node.path.contains("/rep:");d=meta64.isAdminUser||!d;var l=meta64.getHighlightedNode();!h&&l&&l.uid===e&&(h=!0);g=b.makeRowButtonBarHtml(e,g,c,d);c=b.getNodeBkgImageStyle(a);return b.makeTag("div",{"class":"node-table-row"+(h?" active-row":" inactive-row"),
onClick:"nav.clickOnNodeRow(this, '"+e+"');",id:e+"_row",style:c},g+b.makeTag("div",{id:e+"_content"},b.renderNodeContent(a,!0,!0,!0)))},showNodeUrl:function(){var a=meta64.getHighlightedNode();if(a){var c=window.location.origin+"?id="+a.path;meta64.jqueryChangePage("#mainPage");c="URL using path: <br>"+c;(a=props.getNodePropertyVal("jcr:uuid",a))&&(c+="<p>URL for UUID: <br>"+window.location.origin+"?id="+a);messagePg.showMessage("Full External URL of Node",c)}else alert("You must first click on a node.")},
getTopRightImageTag:function(a){a=props.getNodePropertyVal("img.top.right",a);var c="";a&&(c=b.makeTag("img",{src:a,"class":"top-right-image"},"",!1));return c},getNodeBkgImageStyle:function(a){a=props.getNodePropertyVal("img.node.bkg",a);var c="";a&&(c="background-image: url("+a+");");return c},makeRowButtonBarHtml:function(a,c,d,g){var e=selButton=createSubNodeButton=editNodeButton=moveNodeUpButton=moveNodeDownButton=insertNodeButton="";b.nodeHasChildren(a)&&(e=b.makeTag("a",{onClick:"nav.openNode('"+
a+"');","class":"ui-btn ui-btn-b ui-btn-inline ui-icon-plus ui-mini ui-btn-icon-left"},"Open"));meta64.editMode&&(selButton=b.makeTag("a",{id:a+"_sel",onClick:"nav.toggleNodeSel('"+a+"');","class":"ui-btn ui-btn-inline ui-icon-check ui-mini ui-btn-icon-left "+(meta64.selectedNodes[a]?"ui-btn-b":"ui-btn-a")},"Sel"),cnst.NEW_ON_TOOLBAR&&(createSubNodeButton=b.makeTag("a",{onClick:"edit.createSubNode('"+a+"');","class":"ui-btn ui-btn-inline ui-icon-star ui-mini ui-btn-icon-left"},"New")),cnst.INS_ON_TOOLBAR&&
(insertNodeButton=b.makeTag("a",{onClick:"edit.insertNode('"+a+"');","class":"ui-btn ui-btn-inline ui-icon-bars ui-mini ui-btn-icon-left"},"Ins")));meta64.editMode&&g&&(editNodeButton=b.makeTag("a",{onClick:"edit.runEditNode('"+a+"');","class":"ui-btn ui-btn-inline ui-icon-edit ui-mini ui-btn-icon-left"},"Edit"),meta64.currentNode.childrenOrdered&&(c&&(moveNodeUpButton=b.makeTag("a",{onClick:"edit.moveNodeUp('"+a+"');","class":"ui-btn ui-btn-inline ui-icon-arrow-u ui-mini ui-btn-icon-left"},"Up")),
d&&(moveNodeDownButton=b.makeTag("a",{onClick:"edit.moveNodeDown('"+a+"');","class":"ui-btn ui-btn-inline ui-icon-arrow-d ui-mini ui-btn-icon-left"},"Dn"))));a=selButton+e+insertNodeButton+createSubNodeButton+editNodeButton+moveNodeUpButton+moveNodeDownButton;return 0<a.length?b.makeHorizontalFieldSet(a,"compact-field-contain"):""},makeHorizontalFieldSet:function(a,c){var d=b.makeTag("fieldset",{"data-role":"controlgroup","data-type":"horizontal"},a);return b.makeTag("div",{"class":"ui-field-contain"+
(c?" "+c:"")},d)},makeHorzControlGroup:function(a){return b.makeTag("div",{"data-role":"controlgroup","data-type":"horizontal"},a)},makeRadioButton:function(a,c,d,g){return b.makeTag("input",{type:"radio",name:c,id:d,checked:g?"checked":"unchecked"},"",!0)+b.makeTag("label",{"for":d},a)},nodeHasChildren:function(a){var c=meta64.uidToNodeMap[a];if(c)return c.hasChildren;console.log("Unknown nodeId in nodeHasChildren: "+a);return!1},formatPath:function(a){var c=a.path,c=meta64.isAdminUser?c:c.replaceAll("/root",
"");return c+=" ["+a.primaryTypeName+"]"},markdown:function(a){d||(d=(new Markdown.getSanitizingConverter).makeHtml);return"<div data-ajax='false'>"+d(a)+"</div>"},renderMainPageControls:function(){var a="";0<srch.numSearchResults()&&(a+=render.makeTag("a",{onClick:"nav.showSearchPage();","class":"ui-btn ui-btn-inline ui-icon-search ui-btn-icon-left"},"Back to Search Results"));var c=0<a.length;c&&util.setHtmlEnhanced($("#mainPageControls"),a);util.setVisibility("#mainPageControls",c)},renderPageFromData:function(a){var c=
!1;a?c=!0:a=meta64.currentNodeData;if(a&&a.node){util.setVisibility("#listView",!0);b.renderMainPageControls();meta64.treeDirty=!1;c&&(meta64.uidToNodeMap={},meta64.idToNodeMap={},meta64.selectedNodes={},meta64.initNode(a.node),meta64.setCurrentNodeData(a));var d="",g=b.getNodeBkgImageStyle(a.node),e=b.renderNodeContent(a.node,!0,!0,!0);if(0<e.length){var h=a.node.uid,l=h+"_row",m="";meta64.editMode&&"/"!=a.node.path&&(m=b.makeTag("a",{onClick:"edit.runEditNode('"+h+"');","class":"ui-btn ui-btn-inline ui-icon-edit ui-mini ui-btn-icon-left"},
"Edit"),m=b.makeHorizontalFieldSet(m,"compact-field-contain page-top-button-bar"));g=b.makeTag("div",{"class":"node-table-row page-parent-node inactive-row",onClick:"nav.clickOnNodeRow(this, '"+h+"');",id:l,style:g},m+e);$("#mainNodeContent").show();$("#mainNodeContent").html(g)}else $("#mainNodeContent").hide();$("#mainNodeContent").trigger("updatelayout");view.updateStatusBar();b.renderMainPageControls();if(a.children){var n=a.children.length,p=0;$.each(a.children,function(a,h){var e=b.generateRow(a,
h,c,n,p);0!=e.length&&(d+=e,p++)})}0!=d.length||meta64.isAnonUser||(d=b.makeTag("a",{onClick:"edit.createSubNode();","class":"ui-btn ui-btn-inline ui-icon-star ui-btn-icon-left"},"Create Content"));util.setHtmlEnhancedById("#listView",d);meta64.screenSizeChange();meta64.getHighlightedNode()||util.scrollToTop()}else util.setVisibility("#listView",!1),$("#mainNodeContent").html("No default content is available.")},generateRow:function(a,c,d,g,e){if(meta64.isNodeBlackListed(c))return"";d&&meta64.initNode(c);
e++;return b.renderNodeAsListItem(c,a,g,e)},getUrlForNodeAttachment:function(a){return postTargetUrl+"bin/file-name?nodeId="+encodeURIComponent(a.path)+"&ver="+a.binVer},adjustImageSize:function(a){var c=$("#"+a.imgId);c&&a.width&&a.height&&(a.width>meta64.deviceWidth-80?(c.attr("width","100%"),c.attr("height","auto")):(c.attr("width",a.width),c.attr("height",a.height)))},makeImageTag:function(a){var c=b.getUrlForNodeAttachment(a);a.imgId="imgUid_"+a.uid;if(a.width&&a.height){if(a.width>meta64.deviceWidth-
50){var d=meta64.deviceWidth-50;return b.makeTag("img",{src:c,id:a.imgId,width:d+"px",height:d*a.height/a.width+"px"},null,!1)}return b.makeTag("img",{src:c,id:a.imgId,width:a.width+"px",height:a.height+"px"},null,!1)}return b.makeTag("img",{src:c,id:a.imgId},null,!1)},makeTag:function(a,c,b,d){"undefined"===typeof d&&(d=!0);var e="<"+a;c&&(e+=" ",$.each(c,function(a,c){e=c.contains("'")?e+(a+'="'+c+'" '):e+(a+"='"+c+"' ")}));return e=d?e+(">"+b+"</"+a+">"):e+"/>"},makeEditField:function(a,c){return b.makeTag("label",
{"for":c},a)+b.makeTag("input",{type:"text",name:c,id:c},"",!0)},makePasswordField:function(a,c){return b.makeTag("label",{"for":c},a)+b.makeTag("input",{type:"password",name:c,id:c},"",!0)},makeButton:function(a,c,b,d){b="ui-btn ui-btn-inline ui-btn-"+b;d&&(b+=" "+d);return render.makeTag("a",{id:c,"class":b},a)},makeBackButton:function(a,c,b){return render.makeTag("a",{id:c,"class":"ui-btn ui-icon-carat-l ui-btn-inline ui-btn-"+b,"data-rel":"back"},a)},allowPropertyToDisplay:function(a){return null==
meta64.simpleModePropertyBlackList[a]},isReadOnlyProperty:function(a){return meta64.readOnlyPropertyList[a]},isBinaryProperty:function(a){return meta64.binaryPropertyList[a]},sanitizePropertyName:function(a){return"simple"===meta64.editModeOption?a===jcrCnst.CONTENT?"Content":a:a}};console.log("Module ready: render.js");return b}();console.log("running module: search.js");
...
(a=b.searchResults);var c="",d=a.searchResults.length,g=0;$.each(a.searchResults,function(a,h){meta64.isNodeBlackListed(h)||(b.initSearchNode(h),g++,c+=b.renderSearchResultAsListItem(h,a,d,g))});util.setHtmlEnhanced($("#searchResultsView"),c)},renderSearchResultAsListItem:function(a,c,d,g){c=a.uid;a.name.startsWith("rep:")||meta64.currentNodeData.node.path.contains("/rep:");return render.makeTag("div",{"class":"node-table-row inactive-row",onClick:"srch.clickOnSearchResultRow(this, '"+c+"');",id:c+
...
var share=function(){var d=function(a){c.populateSharingPg(a)},b=function(a,c){var b="";$.each(c.privileges,function(c,d){var g=render.makeTag("a",{onClick:"share.removePrivilege('"+a+"', '"+d.privilegeName+"');","class":"ui-btn ui-btn-inline ui-icon-delete ui-btn-icon-left"},"Remove"),g=render.makeHorizontalFieldSet(g),g=g+("<b>"+a+"</b> has privilege <b>"+d.privilegeName+"</b> on this node.");b+=render.makeTag("div",{"class":"privilege-entry"},g)});return b},a=function(a){util.json("getNodePrivileges",
...
var user=function(){var d=function(a){var c=BRANDING_TITLE;meta64.isAnonUser||(c+=" - "+a.userName);$("#headerUserName").html(c);a=meta64.isAnonUser;$("#openLoginPgButton").text(a?"Login":"Logout")},b=function(a){a.rootNode&&(meta64.homeNodeId=a.rootNode.id,meta64.homeNodePath=a.rootNode.path);meta64.userName=a.userName;meta64.isAdminUser="admin"===a.userName;meta64.isAnonUser="anonymous"===a.userName;meta64.anonUserLandingPageNode=a.anonUserLandingPageNode;meta64.editModeOption=a.userPreferences.advancedMode?
meta64.MODE_ADVANCED:meta64.MODE_SIMPLE},a=function(a,c,f,g){util.checkSuccess("Login",a)?("anonymous"!=c&&(e.writeCookie(cnst.COOKIE_LOGIN_USR,c),e.writeCookie(cnst.COOKIE_LOGIN_PWD,f),e.writeCookie(cnst.COOKIE_LOGIN_STATE,"1")),meta64.jqueryChangePage("#mainPage"),b(a),a.userPreferences.lastNode?console.log("lastNode: "+a.userPreferences.lastNode):console.log("lastNode is null."),c=null,c=util.emptyString(a.homeNodeOverride)?a.userPreferences.lastNode?a.userPreferences.lastNode:meta64.homeNodeId:
a.homeNodeOverride,view.refreshTree(c,!1),d(a)):g&&(alert("Cookie login failed."),$.removeCookie(cnst.COOKIE_LOGIN_USR),$.removeCookie(cnst.COOKIE_LOGIN_PWD),$.writeCookie(cnst.COOKIE_LOGIN_STATE,"0"),location.reload())},c=function(a){window.location.href=window.location.origin},f=function(a){util.checkSuccess("Change password",a)&&alert("Password changed successfully.")},g=function(a){util.checkSuccess("Signup new user",a)&&(user.populateLoginPgFromCookies(),meta64.changePage(loginPg),alert("User Information Accepted. \n\nCheck your email for signup confirmation. (Can take up to 1 minute)"))},
e={twitterLogin:function(){$(window).off("beforeunload");window.location.href=window.location.origin+"/twitterLogin"},openSignupPg:function(){meta64.changePage(signupPg)},writeCookie:function(a,c){$.cookie(a,c,{expires:365,path:"/"})},populateLoginPgFromCookies:function(){var a=$.cookie(cnst.COOKIE_LOGIN_USR),c=$.cookie(cnst.COOKIE_LOGIN_PWD);a&&$("#userName").val(a);c&&$("#password").val(c)},openLoginPg:function(){meta64.isAnonUser?meta64.changePage(loginPg):e.logout(!0)},signup:function(){var a=
util.getRequiredElement("#signupUserName").val(),c=util.getRequiredElement("#signupPassword").val(),b=util.getRequiredElement("#signupEmail").val(),d=util.getRequiredElement("#signupCaptcha").val();util.anyEmpty(a,c,b,d)?alert("Sorry, you cannot leave any fields blank."):util.json("signup",{userName:a,password:c,email:b,captcha:d},g)},pageInitSignupPg:function(){user.tryAnotherCaptcha()},tryAnotherCaptcha:function(){var a=util.currentTimeMillis(),a=postTargetUrl+"captcha?t="+a;$("#captchaImage").attr("src",
a)},refreshLogin:function(){var c,f,e=!1;if("true"===$("#loginSessionReady").text())f=c="",e=!0;else{if("0"===$.cookie(cnst.COOKIE_LOGIN_STATE)){meta64.loadAnonPageHome(!1);return}var g=$.cookie(cnst.COOKIE_LOGIN_USR),p=$.cookie(cnst.COOKIE_LOGIN_PWD),e=!util.emptyString(g)&&!util.emptyString(p);c=g?g:"";f=p?p:""}console.log("refreshLogin with name: "+c);g=util.json("login",{userName:c,password:f,tzOffset:(new Date).getTimezoneOffset(),dst:util.daylightSavingsTime});e?g.done(function(b){a(b,c,f,e)}):
g.done(function(a){b(a);d(a);meta64.loadAnonPageHome(!1)})},login:function(){var c=$.trim($("#userName").val()),b=$.trim($("#password").val());util.json("login",{userName:c,password:b,tzOffset:(new Date).getTimezoneOffset(),dst:util.daylightSavingsTime}).done(function(d){a(d,c,b)})},logout:function(a){meta64.isAnonUser||($(window).off("beforeunload"),a&&user.writeCookie(cnst.COOKIE_LOGIN_STATE,"0"),util.json("logout",{},c))},changePassword:function(){var a=util.getRequiredElement("#changePassword1").val(),
c=util.getRequiredElement("#changePassword2").val();a&&4<=a.length&&a===c?util.json("changePassword",{newPassword:a},f):alert("Sorry, invalid password(s).")},changePasswordPg:function(){meta64.changePage(changePasswordPg)}};console.log("Module ready: user.js");return e}();console.log("running module: util.js");
var util=function(){Date.prototype.stdTimezoneOffset=function(){var a=new Date(this.getFullYear(),0,1),c=new Date(this.getFullYear(),6,1);return Math.max(a.getTimezoneOffset(),c.getTimezoneOffset())};Date.prototype.dst=function(){return this.getTimezoneOffset()<this.stdTimezoneOffset()};"function"!=typeof String.prototype.startsWith&&(String.prototype.startsWith=function(a){return 0===this.indexOf(a)});"function"!=typeof String.prototype.contains&&(String.prototype.contains=function(a){return-1!=
this.indexOf(a)});"function"!=typeof String.prototype.replaceAll&&(String.prototype.replaceAll=function(a,c){return this.replace(new RegExp(a.replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1"),"g"),c)});var d=0,b={daylightSavingsTime:(new Date).dst()?!0:!1,json:function(a,c,b){d++;a=$.ajax({url:postTargetUrl+a,contentType:"application/json",type:"post",dataType:"json",cache:!1,data:JSON.stringify(c)});a.done(function(a){"function"==typeof b&&b(a)});a.fail(function(a,c){alert("Server request failed.")});
a.complete(function(){d--});return a},ajaxReady:function(a){return 0<d?(console.log("Ignoring requests: "+a+". Ajax currently in progress."),!1):!0},isAjaxWaiting:function(){return 0<d},delayedFocus:function(a){setTimeout(function(){$(a).focus()},500)},checkSuccess:function(a,c){c.success||alert(a+" failed: "+c.message);return c.success},addAll:function(a,c){for(var b=0;b<c.length;b++)c[b]?a[c[b]]=!0:console.error("null element in addAll at idx="+b)},nullOrUndef:function(a){return null===a||void 0===
a},getUidForId:function(a,c){var b=a[c];b||(b=meta64.nextUid++,a[c]=b);return b},getPreviousPage:function(){var a="#"+$.mobile.activePage.prev('div[data-role="page"]')[0].id;alert("prevPage="+a);return a},domElm:function(a){if(a.contains("#"))return console.log("do not use # in domElm"),null;var c=document.getElementById(a);c&&0!=c.length||console.log("domElm Error. Required element id not found: "+a);return c},getRequiredElement:function(a){var c=$(a);null==c&&console.log("getRequiredElement. Required element id not found: "+
a);return c},isObject:function(a){return a&&0!=a.length},currentTimeMillis:function(){return(new Date).getMilliseconds()},emptyString:function(a){return!a||0==a.length},setEnablement:function(a,c,d){"undefined"===typeof d||d?b.setVisibility(a,!0):b.setVisibility(a,!1);c&&a.removeClass("ui-state-disabled");c||a.addClass("ui-state-disabled")},hookSliderChanges:function(){for(var a=0;a<arguments.length;a++){var c=arguments[a]+"SliderChange",b=window[c];"function"!==typeof b&&alert("Function not found: "+
c);if(!hookSlider("#"+arguments[a]+"Slider",b)){alert("Failed to hook slider: "+arguments[a]);break}}},hookSlider:function(a,c){b.getRequiredElement(a).change(c);return!0},bindEnterKey:function(a,c){b.bindKey(a,c,13)},bindKey:function(a,c,b){$(a).keypress(function(a){if(a.which==b)return c(),!1})},anyEmpty:function(){for(var a=0;a<arguments.length;a++){var c=arguments[a];if(!c||0==c.length)return!0}return!1},changeOrAddClass:function(a,c,b){a=$(a);a.toggleClass(c,!1);a.toggleClass(b,!0)},changeOrAddClass__mine:function(a,
c,b){if(a.className&&0!=a.className.length){for(var d=a.className.split(" "),e="",h=!1,l=0;l<d.length;l++){var m=d[l];if(m===b){if(h)continue;h=!0}else if(m===c){if(h)continue;m=b;h=!0}0<e.length&&(e+=" ");e+=m}h||(0<e.length&&(e+=" "),e+=b);a.className=e}else console.log("no existing className is available on element, so assigning to "+b),a.className=b},verifyType:function(a,c,b){return typeof a!==c?(alert(b),!1):!0},setHtmlEnhancedById:function(a,c){var d=b.getRequiredElement(a);d?($(d).html(c),
...
$("html, body").animate({scrollTop:b})}},1E3)},initEditPathDisplayById:function(b){var a=edit.editNode;b=$(b);if(edit.editingUnsavedNode)b.html(""),b.hide();else{var c="Path: "+render.formatPath(a),c=c+("<br>ID: "+a.id),c=c+("<br>Modified: "+a.lastModified);b.html(c);b.show()}b.trigger("updatelayout")}};console.log("Module ready: view.js");return d}();
