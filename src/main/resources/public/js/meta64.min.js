...
var edit=function(){var d,b,a=function(a){util.checkSuccess("Save node",a);view.refreshTree(null,!1);meta64.changePage("#mainPage");view.scrollToSelectedNode()},c=function(a){util.checkSuccess("Export",a)&&(alert("Export Successful."),meta64.changePage("#mainPage"),view.scrollToSelectedNode())},e=function(a){util.checkSuccess("Import",a)&&(alert("Import Successful."),view.refreshTree(null,!1),meta64.changePage("#mainPage"),view.scrollToSelectedNode())},h=function(a){console.log("insertBookResponse running.");util.checkSuccess("Insert Book",
...
[],e=0,g=0;;){var d="editNodeTextContent"+e;if(meta64.fieldIdToPropMap.hasOwnProperty(d)){var h=meta64.fieldIdToPropMap[d],d=$("#"+d).val();d!==h.value&&(c.push({name:h.name,value:d}),g++)}else break;e++}0<g?(util.json("saveNode",{nodeId:l.editNode.id,properties:c,sendNotification:b},a),b=!1):alert("You didn't change any information!")},moveNodeUp:function(a){var c=meta64.uidToNodeMap[a];c?(a=meta64.getOrdinalOfNode(c),console.log("ordinal="+a),-1==a&&0>=a||util.json("setNodePosition",{parentNodeId:meta64.currentNodeId,
...
updateNodeInfo:function(a){util.json("getNodePrivileges",{nodeId:a.id,includeAcl:!1,includeOwners:!0}).done(function(c){b.updateNodeInfoResponse(c,a)})},getNodeFromId:function(a){return b.idToNodeMap[a]},getPathOfUid:function(a){var c=b.uidToNodeMap[a];return c?c.path:"[path error. invalid uid: "+a+"]"},addClickListeners:function(){$("#openLoginPgButton").on("click",user.openLoginPg);$("#navHomeButton").on("click",nav.navHome);$("#navUpLevelButton").on("click",nav.navUpLevel);$("#propsToggleButton").on("click",
props.propsToggle);$("#deletePropertyButton").on("click",props.deleteProperty);$("#editModeButton").on("click",edit.editMode);$("#makeNodeReferencableButton").on("click",edit.makeNodeReferencable)},openDonatePg:function(){meta64.changePage("#donatePg")},getHighlightedNode:function(){return b.parentUidToFocusNodeMap[b.currentNodeUid]},highlightRowById:function(a,c){var e=b.getNodeFromId(a);e?b.highlightNode(e,c):console.log("highlightRowById failed to find id: "+a)},highlightNode:function(a,c){if(a){var e=
!1,d=b.parentUidToFocusNodeMap[b.currentNodeUid];d&&(d.uid===a.uid?e=!0:(d=d.uid+"_row",d=$("#"+d),util.changeOrAddClass(d,"active-row","inactive-row")));e||(b.parentUidToFocusNodeMap[b.currentNodeUid]=a,d=a.uid+"_row",d=$("#"+d),util.changeOrAddClass(d,"inactive-row","active-row"));c&&view.scrollToSelectedNode()}},refreshAllGuiEnablement:function(){util.getPropertyCount(b.selectedNodes);var a=b.getHighlightedNode();util.setEnablement($("#navHomeButton"),b.currentNode&&!nav.displayingHome());util.setEnablement($("#navUpLevelButton"),
b.currentNode&&nav.parentVisibleToUser());var c=b.currentNode&&!b.isAnonUser;util.setEnablement($("#propsToggleButton"),c);util.setEnablement($("#deletePropertyButton"),!b.isAnonUser);c=b.currentNode&&!b.isAnonUser;util.setEnablement($("#editModeButton"),c);util.setVisibility("#menuButton",!b.isAnonUser);util.setVisibility("#mainMenuSearchButton",!b.isAnonUser&&null!=a);util.setVisibility("#mainMenuTimelineButton",!b.isAnonUser&&null!=a)},getSingleSelectedNode:function(){for(var a in b.selectedNodes)if(b.selectedNodes.hasOwnProperty(a))return b.uidToNodeMap[a];
return null},getOrdinalOfNode:function(a){if(!b.currentNodeData||!b.currentNodeData.children)return-1;for(var c=0;c<b.currentNodeData.children.length;c++)if(a.id===b.currentNodeData.children[c].id)return c;return-1},setCurrentNodeData:function(a){b.currentNodeData=a;b.currentNode=a.node;b.currentNodeUid=a.node.uid;b.currentNodeId=a.node.id;b.currentNodePath=a.node.path},anonPageLoadResponse:function(a){a.renderNodeResponse?(util.setVisibility("#mainNodeContent",!0),util.setVisibility("#mainNodeStatusBar",
...
initConstants:function(){util.addAll(b.simpleModePropertyBlackList,[jcrCnst.PRIMARY_TYPE,jcrCnst.POLICY]);util.addAll(b.readOnlyPropertyList,[jcrCnst.UUID,jcrCnst.MIXIN_TYPES,jcrCnst.CREATED,jcrCnst.CREATED_BY,jcrCnst.LAST_MODIFIED,jcrCnst.LAST_MODIFIED_BY,jcrCnst.IMG_WIDTH,jcrCnst.IMG_HEIGHT,jcrCnst.BIN_VER,jcrCnst.BIN_DATA,jcrCnst.BIN_MIME]);util.addAll(b.binaryPropertyList,[jcrCnst.BIN_DATA])},initApp:function(){d||(console.log("initApp running."),d=!0,b.initConstants(),b.displaySignupMessage(),
$(window).on("orientationchange",b.orientationHandler),b.addClickListeners(),b.deviceWidth=$(window).width(),b.deviceHeight=$(window).height(),user.refreshLogin(),pageMgr.initializePageBuilders(),setInterval(function(){var a=$(window).width();a!=b.deviceWidth&&(b.deviceWidth=a,b.deviceHeight=$(window).height(),b.screenSizeChange())},1500),b.refreshAllGuiEnablement())},displaySignupMessage:function(){"ok"===$("#signupCodeResponse").text()&&alert("Signup complete. You may now login.")},screenSizeChange:function(){b.currentNodeData&&
$.each(b.currentNodeData.children,function(a,c){c.imgId&&render.adjustImageSize(c)})},orientationHandler:function(a){},loadAnonPageHome:function(a){util.json("anonPageLoad",{ignoreUrl:a},b.anonPageLoadResponse)}};console.log("Module ready: meta64.js");return b}();console.log("running module: nav.js");
...
"edit.moveSelNodes();")+b("Finish Moving","finishMovingSelNodesButton","edit.finishMovingSelNodes();")+b("Export","openExportPgButton","edit.openExportPg();")+b("Import","openImportPgButton","edit.openImportPg();")+b("Delete","deleteSelNodesButton","edit.deleteSelNodes();"),e=d("Edit",e),a=render.makeTag("div",{style:"margin: 0; min-width: 300px; position: fixed; top: 2em; left: 2em;","data-role":"collapsible-set"},a+e);util.setHtmlEnhanced($("#popupMenuPg"),a)},init:function(){var c=util.getPropertyCount(meta64.selectedNodes),
b=meta64.getHighlightedNode(),d=!util.nullOrUndef(edit.nodesToMove)&&!a.isAnonUser;util.setEnablement($("#changePasswordPgButton"),!meta64.isAnonUser);util.setEnablement($("#accountPreferencesPgButton"),!meta64.isAnonUser);util.setEnablement($("#insertBookWarAndPeaceButton"),meta64.isAdminUser&&null!=b,meta64.isAdminUser);util.setEnablement($("#donatePgButton"),!0);util.setEnablement($("#manageAttachmentsButton"),null!=b);util.setEnablement($("#editNodeSharingButton"),null!=b);util.setEnablement($("#moveSelNodesButton"),
null!=b);util.setEnablement($("#finishMovingSelNodesButton"),d);util.setEnablement($("#openExportPgButton"),meta64.isAdminUser,meta64.isAdminUser);util.setEnablement($("#openImportPgButton"),meta64.isAdminUser,meta64.isAdminUser);util.setEnablement($("#deleteSelNodesButton"),c)}};console.log("Module ready: popupMenuPg.js");return a}();console.log("running module: prefsPg.js");
...
c.properties[b];if(d.name===a)return d}return null},renderProperty:function(a){return a.values?b.renderPropertyValues(a.values):a.value&&0!=a.value.length?render.markdown(a.value):""},renderPropertyValues:function(a){var c="<div>";$.each(a,function(a,b){c+=render.markdown(b)+cnst.BR});return c+="</div>"}};console.log("Module ready: props.js");return b}();console.log("running module: render.js");
var render=function(){var d,b={renderNodeContent:function(a,c,e,d,f){var g="";e&&meta64.editMode&&(g+="<div class='path-display'>Path: "+b.formatPath(a)+"</div>",g+="<div>",a.createdBy&&(g+="<span class='"+(a.createdBy===meta64.userName?"created-by-me":"created-by-other")+"'>Created By: "+a.createdBy+"</span>"),g+="<span id='ownerDisplay"+a.uid+"'></span>",a.lastModified&&(g+="  Modified: "+a.lastModified),g+="</div>");!c||!meta64.editMode||a.id===a.path&&e||(g+="ID: "+a.id+cnst.BR);d&&!e&&a.name&&
(g+="Name: "+a.name+" [uid="+a.uid+"]");c="";g&&(c+=b.makeTag("div",{"class":"header-text"},g));if(meta64.showProperties)(g=props.renderProperties(a.properties))&&(c+=g);else if(g=props.getNodeProperty(jcrCnst.CONTENT,a))g=props.renderProperty(g),0<g.length&&(c+=b.makeTag("div",{"class":"jcr-content"},b.markdown(g)));f&&a.hasBinary&&(a.binaryIsImage?a=b.makeImageTag(a):(a=b.makeTag("a",{href:b.getUrlForNodeAttachment(a)},"[Download Attachment]"),a=b.makeTag("div",{"class":"binary-link"},a)),c=c.contains(cnst.INSERT_ATTACHMENT)?
c.replaceAll(cnst.INSERT_ATTACHMENT,a):c+a);return c},renderNodeAsListItem:function(a,c,e,d){var f=a.uid,g=a.id===meta64.newChildNodeId;d=0<c&&1<d;c=c<e-1;e=a.name.startsWith("rep:")||meta64.currentNodeData.node.path.contains("/rep:");e=meta64.isAdminUser||!e;var k=meta64.getHighlightedNode();!g&&k&&k.uid===f&&(g=!0);d=b.makeRowButtonBarHtml(f,d,c,e);return b.makeTag("div",{"class":"node-table-row"+(g?" active-row":" inactive-row"),onClick:"nav.clickOnNodeRow(this, '"+f+"');",id:f+"_row"},d+b.makeTag("div",
{id:f+"_content"},b.renderNodeContent(a,!0,!0,!0,!0)))},makeRowButtonBarHtml:function(a,c,d,h){var f=selButton=createSubNodeButton=editNodeButton=moveNodeUpButton=moveNodeDownButton=insertNodeButton="";b.nodeHasChildren(a)&&(f=b.makeTag("a",{onClick:"nav.openNode('"+a+"');","class":"ui-btn ui-btn-b ui-btn-inline ui-icon-plus ui-mini ui-btn-icon-left"},"Open"));meta64.editMode&&(selButton=b.makeTag("a",{id:a+"_sel",onClick:"nav.toggleNodeSel('"+a+"');","class":"ui-btn ui-btn-inline ui-icon-check ui-mini ui-btn-icon-left "+
...
"Edit"),meta64.currentNode.childrenOrdered&&(c&&(moveNodeUpButton=b.makeTag("a",{onClick:"edit.moveNodeUp('"+a+"');","class":"ui-btn ui-btn-inline ui-icon-arrow-u ui-mini ui-btn-icon-left"},"Up")),d&&(moveNodeDownButton=b.makeTag("a",{onClick:"edit.moveNodeDown('"+a+"');","class":"ui-btn ui-btn-inline ui-icon-arrow-d ui-mini ui-btn-icon-left"},"Dn"))));a=selButton+f+insertNodeButton+createSubNodeButton+editNodeButton+moveNodeUpButton+moveNodeDownButton;return 0<a.length?b.makeHorizontalFieldSet(a,
"compact-field-contain"):""},makeHorizontalFieldSet:function(a,c){var d=b.makeTag("fieldset",{"data-role":"controlgroup","data-type":"horizontal"},a);return b.makeTag("div",{"class":"ui-field-contain"+(c?" "+c:"")},d)},makeHorzControlGroup:function(a){return b.makeTag("div",{"data-role":"controlgroup","data-type":"horizontal"},a)},makeRadioButton:function(a,c,d,h){return b.makeTag("input",{type:"radio",name:c,id:d,checked:h?"checked":"unchecked"},"",!0)+b.makeTag("label",{"for":d},a)},nodeHasChildren:function(a){var c=
meta64.uidToNodeMap[a];if(c)return c.hasChildren;console.log("Unknown nodeId in nodeHasChildren: "+a);return!1},formatPath:function(a){var c=a.path,c=meta64.isAdminUser?c:c.replaceAll("/root","");return c+=" ["+a.primaryTypeName+"]"},markdown:function(a){d||(d=(new Markdown.getSanitizingConverter).makeHtml);return"<div data-ajax='false'>"+d(a)+"</div>"},renderMainPageControls:function(){var a="";0<srch.numSearchResults()&&(a+=render.makeTag("a",{onClick:"nav.showSearchPage();","class":"ui-btn ui-btn-inline ui-icon-search ui-btn-icon-left"},
"Back to Search Results"));var c=0<a.length;c&&util.setHtmlEnhanced($("#mainPageControls"),a);util.setVisibility("#mainPageControls",c)},renderPageFromData:function(a){var c=!1;a?c=!0:a=meta64.currentNodeData;if(a&&a.node){util.setVisibility("#listView",!0);b.renderMainPageControls();meta64.treeDirty=!1;c&&(meta64.uidToNodeMap={},meta64.idToNodeMap={},meta64.selectedNodes={},meta64.initNode(a.node),meta64.setCurrentNodeData(a));var d="",h=b.renderNodeContent(a.node,!0,!0,!0,!0);if(0<h.length){var f=
a.node.uid,h=b.makeTag("div",{"class":"node-table-row inactive-row",onClick:"nav.clickOnNodeRow(this, '"+f+"');",id:f+"_row"},h);$("#mainNodeContent").show();$("#mainNodeContent").html(h)}else $("#mainNodeContent").hide();view.updateStatusBar();b.renderMainPageControls();if(a.children){var g=a.children.length,k=0;$.each(a.children,function(a,f){var h=b.generateRow(a,f,c,g,k);0!=h.length&&(d+=h,k++)})}0!=d.length||meta64.isAnonUser||(d=b.makeTag("a",{onClick:"edit.createSubNode();","class":"ui-btn ui-btn-inline ui-icon-star ui-btn-icon-left"},
"Create Content"));util.setHtmlEnhancedById("#listView",d);meta64.getHighlightedNode()||util.scrollToTop()}else util.setVisibility("#listView",!1),$("#mainNodeContent").html("No default content is available.")},generateRow:function(a,c,d,h,f){if(meta64.isNodeBlackListed(c))return"";d&&meta64.initNode(c);f++;return b.renderNodeAsListItem(c,a,h,f)},getUrlForNodeAttachment:function(a){return postTargetUrl+"bin?nodeId="+encodeURIComponent(a.path)+"&ver="+a.binVer},adjustImageSize:function(a){var c=$("#"+
a.imgId);if(c){var b=c.attr("width"),d=c.attr("height");a.width&&a.height&&(a.width>meta64.deviceWidth-50?(b=meta64.deviceWidth-50,d=b*a.height/a.width,c.attr("width",b),c.attr("height",d)):(c.attr("width",a.width),c.attr("height",a.height)))}},makeImageTag:function(a){var c=b.getUrlForNodeAttachment(a);a.imgId="imgUid_"+a.uid;if(a.width&&a.height){if(a.width>meta64.deviceWidth-50){var d=meta64.deviceWidth-50;return b.makeTag("img",{src:c,id:a.imgId,width:d+"px",height:d*a.height/a.width+"px"},null,
!1)}return b.makeTag("img",{src:c,id:a.imgId,width:a.width+"px",height:a.height+"px"},null,!1)}return b.makeTag("img",{src:c,id:a.imgId},null,!1)},makeTag:function(a,b,d,h){"undefined"===typeof h&&(h=!0);var f="<"+a;b&&(f+=" ",$.each(b,function(a,b){f=b.contains("'")?f+(a+'="'+b+'" '):f+(a+"='"+b+"' ")}));return f=h?f+(">"+d+"</"+a+">"):f+"/>"},makeEditField:function(a,c){return b.makeTag("label",{"for":c},a)+b.makeTag("input",{type:"text",name:c,id:c},"",!0)},makePasswordField:function(a,c){return b.makeTag("label",
{"for":c},a)+b.makeTag("input",{type:"password",name:c,id:c},"",!0)},makeButton:function(a,b,d,h){d="ui-btn ui-btn-inline ui-btn-"+d;h&&(d+=" "+h);return render.makeTag("a",{id:b,"class":d},a)},makeBackButton:function(a,b,d){return render.makeTag("a",{id:b,"class":"ui-btn ui-icon-carat-l ui-btn-inline ui-btn-"+d,"data-rel":"back"},a)},allowPropertyToDisplay:function(a){return null==meta64.simpleModePropertyBlackList[a]},isReadOnlyProperty:function(a){return meta64.readOnlyPropertyList[a]},isBinaryProperty:function(a){return meta64.binaryPropertyList[a]},
