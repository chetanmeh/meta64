 ...
 * HTML. This is part of the mechanism of how we get settings that originat in server side properties files
 * to be used in the browser, without needing to do an Ajax call to retrieve it.
 */
